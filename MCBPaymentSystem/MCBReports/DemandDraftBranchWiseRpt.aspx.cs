...
public partial class DemandDraftBranchWiseRpt : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        string companyCode, CompanyType, fromDate, toDate;
        companyCode = Request.QueryString["companycode"];
        CompanyType = Request.QueryString["companytype"];
        fromDate = Request.QueryString["fromdate"];
        toDate = Request.QueryString["todate"];
        
        Generate(companyCode, CompanyType, fromDate, toDate);
    }
    private void Generate(string companyCode, string CompanyType, string fromDate, string toDate)
    {
        ...
        try
        {
            ...
            //{
                //Response.Redirect("DemandDraftBranchWiseReport.aspx?IsRecord=" + "0" + "&msg=" + "Session expired, please re-login.");
            //}
            DataTable temp = new DataTable();
            DataTable dt = new DataTable();
            temp = GetData(companyCode, CompanyType, fromDate, toDate);
            if (temp.Rows.Count > 0)
            {
                ReportDataSource rptDataSource = new ReportDataSource
                ("MCB_DataSet_BranchWiseSummary", temp);
                ...
                //rpParameter.Add(new ReportParameter("Company_Type", CompanyType));
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("DemandDraftBranchWiseReport.rdlc");
            ...
            {
                Response.Redirect("DemandDraftBranchWiseReport.aspx?IsRecord=" + "0" + "&msg=" + "No Record Found");
            }
        }
        catch (Exception ex)
        {
    ...
    public string GetReportName()
    {
        ...
        parm[0] = RptObj.OracleDBParameter("v_Report_Code", "R17", "String", "In");
