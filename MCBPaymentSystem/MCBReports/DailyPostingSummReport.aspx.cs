...
public partial class DailyPostingSummReport : System.Web.UI.Page
{
    ...
    protected void btn_OK_Click(object sender, EventArgs e)
    {
        if (TXT_FROM.Text != "" && TXT_TO.Text != "")
        {
            ...
            string TransType = (DDL_TransType.SelectedValue == "ALL" ? "" : DDL_TransType.SelectedValue);
            string AgentType = (DDL_AGENT_TYPE.SelectedValue == "ALL" ? "" : DDL_AGENT_TYPE.SelectedValue);
            string FromDate = TXT_FROM.Text;
            string ToDate = TXT_TO.Text;
            Response.Redirect("DailyPostingSummRpt.aspx?CompanyName=" + CompanyName + "&FromDate=" + FromDate + "&ToDate=" + ToDate + "&AgentType=" + AgentType + "&TransType=" + TransType);
        }
        else
        {
