...
public partial class PaymentCPDReport : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        txt_branchname.Attributes.Add("readonly", "readonly");
    ...
    protected void btn_OK_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("PaymentCPDRpt.aspx?companycode=" + companycode + "&status=" + status + "&fromdate=" + fromDate + "&todate=" + toDate + "&trans_type=" + trans_type + "&selecttype=" + selecttype+"&Branchid="+txtBranchCode.Text +"&Userid="+txt_userid.Text);
    }
    ...
    protected void btnLov_Click(object sender, ImageClickEventArgs e)
    {
        ...
        {
            txtBranchCode.Text = Session["LOV_ID"].ToString();
           txt_branchname.Text = Session["LOV_DESCRIPTION"].ToString();
        }
    }
    protected void btnlovuserid_Click(object sender, ImageClickEventArgs e)
    {
        if (Session["LOV_ID"].ToString() != "")
        {
            txt_userid.Text = Session["USR_NAME"].ToString();
            txt_username.Text = Session["REAL_NAME"].ToString();
        }
    }
}
