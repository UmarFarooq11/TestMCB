...
public partial class PaymentCPDRpt : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        string companyCode, Status, fromDate, toDate, trans_type, selecttype,Branchid,Userid;
        ...
        Generate(companyCode, Status, fromDate, toDate, trans_type, selecttype, Branchid, Userid);
    }
    private void Generate(string companyCode, string status, string fromDate, string toDate, string trans_type, string selecttype,string Branchid, string Userid)
    {
        ...
        try
        {
            ...
            temp = GetData(companyCode, status, fromDate, toDate, trans_type, selecttype, Branchid, Userid);
            if (temp.Rows.Count > 0)
            {
                ReportDataSource rptDataSource = new ReportDataSource
                ("MCB_DataSet_PaymentCPD", temp);
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("PaymentCPDReport.rdlc");
            ...
            {
                Response.Redirect("PaymentCPDReport.aspx?IsRecord=" + "0" + "&msg=" + "No Record Found");
            }
        }
        catch (Exception ex)
        {
    ...
    public string GetReportName()
    {
        ...
        parm[0] = RptObj.OracleDBParameter("v_Report_Code", "R13", "String", "In");
