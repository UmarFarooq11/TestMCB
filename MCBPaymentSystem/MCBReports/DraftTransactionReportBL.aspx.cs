...
public partial class DraftTransactionReportBL : System.Web.UI.Page
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        if (Page.IsValid)
        {
            if (ValidateDate())
            {
                Response.Redirect("DraftTransactionRptBL.aspx?CompanyCode=" + ddlCompanyCode.SelectedValue + "&fileName=" + ddlFile.SelectedValue + "&Authorize1=" + txtAuthorize1.Text + "&Authorize2=" + txtAuthorize2.Text + "&IBC1=" + txtIBC1.Text + "&IBC2=" + txtIBC2.Text);
            }
        }
    }
