...
public partial class HomeRemitanceRpt : System.Web.UI.Page
{
    ...
    private void Generate(string month)
    {
        ...
        try
        {
            ...
            if (temp.Rows.Count > 0)
            {
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("HomeRemitanceReport.rdlc");
            ...
            {
                Response.Redirect("HomeRemitanceReport.aspx?IsRecord=" + "0" + "&msg=" + "No Record Found");
            }
        }
        catch (Exception ex)
        {
    ...
    private DataTable GetData(string month)
    {
        ...
        dsReport = RptObj.Oracle_GetDataSetSP("sp_home_remittance_rpt", parm);
    ...
    public string GetReportName()
    {
        ...
        DataSet dsReport = new DataSet();
        OracleParameter[] parm = new OracleParameter[2];
        parm[0] = RptObj.OracleDBParameter("v_Report_Code", "R15", "String", "In");
