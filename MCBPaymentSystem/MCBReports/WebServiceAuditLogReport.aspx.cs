...
public partial class WebServiceAuditLogReport : System.Web.UI.Page
{
    ...
    protected void btn_OK_Click(object sender, EventArgs e)
    {
        ...
        if (txtPinCode.Text != "")
        {
            ...
            lblmessage.Text = "";
            Response.Redirect("WebServiceAuditLogRpt.aspx?PinCode=" + PinCode);
        }
        else
        {
            lblmessage.Text = "Please enter Pin Code.";
        }
    }
}
