...
public partial class OtherBankTransactionRpt : System.Web.UI.Page
{
    ...
    private void Generate(string date)
    {
        ...
        try
        {
            ...
            if (temp.Rows.Count > 0)
            {
                ...
                ("MCB_DataSet_OtherBankTrans", temp);
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("OtherBankTransactionReport.rdlc");
            ...
            {
                Response.Redirect("OtherBankTransactionReport.aspx?IsRecord=" + "0" + "&msg=" + "No Record Found");
            }
        }
        catch (Exception ex)
        {
    ...
    public string GetReportName()
    {
        ...
        DataSet dsReport = new DataSet();
        OracleParameter[] parm = new OracleParameter[2];
        parm[0] = RptObj.OracleDBParameter("v_Report_Code", "R19", "String", "In");
