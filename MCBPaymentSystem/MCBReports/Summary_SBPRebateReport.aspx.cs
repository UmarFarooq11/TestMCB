...
public partial class Summary_SBPRebateReport : System.Web.UI.Page
{
    ...
    protected void btn_OK_Click(object sender, EventArgs e)
    {
        if (TXT_FROM.Text != "" && TXT_TO.Text != "" && txt_FC_SaudiRiyal.Text != "" && txt_UsRate.Text != "")
        {
            ...
            Response.Redirect("Summary_SBPRebateRpt.aspx?FromDate=" + FromDate + "&ToDate=" + ToDate + "&USRate=" + USRate + "&fc_saudiRiyal=" + fc_saudiRiyal + "&CompanyName=" + CompanyName);
        }
        else
        {
