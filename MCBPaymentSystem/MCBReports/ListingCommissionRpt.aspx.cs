...
public partial class ListingCommissionRpt : System.Web.UI.Page
{
    ...
    private void Generate(string month)
    {
        ...
        try
        {
            ...
            if (temp.Rows.Count > 0)
            {
                ...
                ("MCB_DataSet_ListingCommission", temp);
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("ListingCommissionReport.rdlc");
            ...
            {
                Response.Redirect("ListingCommissionReport.aspx?IsRecord=" + "0" + "&msg=" + "No Record Found");
            }
        }
        catch (Exception ex)
        {
    ...
    private DataTable GetData(string month)
    {
        ...
        dsReport = RptObj.Oracle_GetDataSetSP("sp_list_comm_mon_report", parm);
    ...
    public string GetReportName()
    {
        ...
        DataSet dsReport = new DataSet();
        OracleParameter[] parm = new OracleParameter[2];
        parm[0] = RptObj.OracleDBParameter("v_Report_Code", "R20", "String", "In");
