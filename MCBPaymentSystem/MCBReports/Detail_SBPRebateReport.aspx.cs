...
public partial class Detail_SBPRebateReport : System.Web.UI.Page
{
    ...
    {
        // if (TXT_MONTH.Text != "" && txt_FC_SaudiRiyal.Text != "" && txt_UsRate.Text != "") Commit by Yaseen 28-01-14
        if (TXT_FROM.Text != "" && TXT_TO.Text != "" && txt_FC_SaudiRiyal.Text != "" && txt_UsRate.Text != "")
        {
            string USRate = txt_UsRate.Text;
            string fc_saudiRiyal = txt_FC_SaudiRiyal.Text;
            //string fc_equiPakRs = txt_EquiPakRs.Text;
            ...
            // Response.Redirect("Detail_SBPRebateRpt.aspx?Month=" + Month + "&USRate=" + USRate + "&fc_saudiRiyal=" + fc_saudiRiyal + "&CompanyName=" + CompanyName); Commit by Yaseen 28-01-14
            Response.Redirect("Detail_SBPRebateRpt.aspx?FromDate=" + FromDate + "&ToDate=" + ToDate + "&USRate=" + USRate + "&fc_saudiRiyal=" + fc_saudiRiyal + "&CompanyName=" + CompanyName);
        }
        else
        {
