...
public partial class PaymentSummaryRpt : System.Web.UI.Page
{
    ...
    private void Generate(string date)
    {
        ...
        try
        {
            ...
            if (temp.Rows.Count > 0)
            {
                ...
                ("MCB_DataSet_PaymentSummary", temp);
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("PaymentSummaryReport.rdlc");
            ...
            {
                Response.Redirect("PaymentSummaryReport.aspx?IsRecord=" + "0" + "&msg=" + "No Record Found");
            }
        }
        catch (Exception ex)
        {
    ...
    private DataTable GetData(string date)
    {
        ...
        dsReport = RptObj.Oracle_GetDataSetSP("sp_payment_Summary", parm);
    ...
    public string GetReportName()
    {
        ...
        DataSet dsReport = new DataSet();
        OracleParameter[] parm = new OracleParameter[2];
        parm[0] = RptObj.OracleDBParameter("v_Report_Code", "R14", "String", "In");
