...
public partial class SymbolDataReset : System.Web.UI.Page
{
    string[] ARY;
    string RGS_SUPPORT;
    ...
    private void loadGrid(string check)
    {
        ...
        parms[7] = _dbConfig.Oracle_Param("P_type", OracleType.VarChar, ParameterDirection.Input, "17");
