...
public partial class OutstandingRpt : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string companyCode, Status, fromDate, toDate, trans_type, selecttype, company_type;
        ...
        company_type = Request.QueryString["companytype"];
        Generate(companyCode, Status, fromDate, toDate, trans_type, selecttype, company_type);
    ...
    private void Generate(string companyCode, string status, string fromDate, string toDate, string trans_type, string selecttype, string CompanyType)
    {
        ...
        try
        {
            ...
            {
                Response.Redirect("OutstandingReport.aspx?IsRecord=" + "0" + "&msg=" + "Session expired, please re-login.");
            }
            ...
            if (temp.Rows.Count > 0)
            {
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("OutstandingReport.rdlc");
            ...
            {
                // Response.Redirect("OutstandingReport.aspx?IsRecord=" + "0" + "&msg=" + "No Record Found");
    ...
    public string GetReportName()
    {
        ...
        parm[0] = RptObj.OracleDBParameter("v_Report_Code", "R7", "String", "In");
