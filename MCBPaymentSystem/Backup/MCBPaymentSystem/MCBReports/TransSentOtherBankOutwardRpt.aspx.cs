...
public partial class TransSentOtherBankOutwardRpt : System.Web.UI.Page
{
    ...
    private void Generate(string date)
    {
        ...
        try
        {
            ...
            if (temp.Rows.Count > 0)
            {
                ...
                ("MCB_DataSet_TransSentOtherBankOut", temp);
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("TransSentOtherBankOutwardReport.rdlc");
            ...
            {
                Response.Redirect("TransSentOtherBankOutwardReport.aspx?IsRecord=" + "0" + "&msg=" + "No Record Found");
            }
        }
        catch (Exception ex)
        {
    ...
    private DataTable GetData(string date)
    {
        ...
        parm[1] = RptObj.OracleDBParameter("p_data_set", "", "Cursor", "Out");
        dsReport = RptObj.Oracle_GetDataSetSP("sp_trans_sent_to_pri_out", parm);
    ...
    public string GetReportName()
    {
        ...
        DataSet dsReport = new DataSet();
        OracleParameter[] parm = new OracleParameter[2];
        parm[0] = RptObj.OracleDBParameter("v_Report_Code", "R18", "String", "In");
