...
public partial class FileLogRpt : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        string companyCode, fromDate, toDate, COMPANYNAME, balance, companytype, trans_type;
      ...
      //  COMPANYNAME = Request.QueryString["COMPANYNAME"];
        ...
        Generate(companyCode, fromDate, toDate, companytype);
        //Generate(companyCode, fromDate, toDate, trans_type);
    }
    private void Generate(string companyCode, string fromDate, string toDate, string companytype)
    {
        ...
        try
        {
            ...
            temp = GetData(companyCode, fromDate, toDate, companytype);
            if (temp.Rows.Count > 0)
            {
                ReportDataSource rptDataSource = new ReportDataSource
                ("MCB_DataSet_FileLog", temp);
              ...
              //  rpParameter.Add(new ReportParameter("balance", balance));
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("FileLogReport.rdlc");
            ...
            {
               // Response.Redirect("FileLogReport.aspx?IsRecord=" + "0" + "&msg=" + "No Record Found");
