...
public partial class SBPClaimReport : System.Web.UI.Page
{
    ...
    protected void btn_OK_Click(object sender, EventArgs e)
    {
        ...
        if (txtMonth.Text != "")
        {
            ...
            Response.Redirect("SBPClaimRpt.aspx?month=" + month);
        }
        else
        {
            lblmessage.Text = "Please enter / select month.";
        }
    }
