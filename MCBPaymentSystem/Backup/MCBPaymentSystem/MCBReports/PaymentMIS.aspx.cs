...
public partial class PaymentMIS : System.Web.UI.Page
{
    ...
    public void ExportTableData()
    {
        ...
        string attach = "attachment;filename=PaidReport.xls";
        Response.Clear();
