...
public partial class DepositRpt : System.Web.UI.Page
{
    ...
    private void Generate(string companyCode, string status, string fromDate, string toDate, string trans_type, string selecttype,string companyType)
    {
        ...
        try
        {
            ...
            {
                Response.Redirect("DepositReport.aspx?IsRecord=" + "0" + "&msg=" + "Session expired, please re-login.");
            }
            ...
            if (temp.Rows.Count > 0)
            {
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("DepositReport.rdlc");
            ...
            else
            {
               ...
               // Response.Redirect("DepositReport.aspx?IsRecord=" + "0" + "&msg=" + "No Record Found");
            }
        }
        catch (Exception ex)
        {
