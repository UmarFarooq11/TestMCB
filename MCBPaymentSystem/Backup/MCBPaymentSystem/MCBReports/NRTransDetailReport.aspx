<%@ Page Language="C#" MasterPageFile="~/MasterPage/RoutinePage.master" AutoEventWireup="true" CodeFile="NRTransDetailReport.aspx.cs" Inherits="NRTransDetailReport" Title="Untitled Page" %>
            ...
            <tr>
                <td>
                    ...
                    <asp:UpdatePanel id="UpdatePanel1" runat="server">
                        <contenttemplate>
<asp:Label id="lbl_Heading" runat="server" Text="NR Transaction Detail" Width="100%" SkinID="FormViewHeading" Font-Size="Large" CssClass="lblHeading"></asp:Label> <asp:Button id="btn_OK" onclick="btn_OK_Click" runat="server" Text="Generate" Width="78px" ValidationGroup="GP" Font-Bold="True"></asp:Button> 
...
<TABLE style="FONT-SIZE: 8pt; FONT-FAMILY: Verdana" cellSpacing=0 width="100%"><TBODY><TR align=right><TD style="FONT-WEIGHT: bold; COLOR: red; TEXT-ALIGN: center" class="TableColumns" colSpan=5><asp:Label id="lblmessage" runat="server" CssClass="lblMessage"></asp:Label> <asp:UpdateProgress id="UpdateProgress1" runat="server">
            ...
            </asp:DropDownList></TD><TD style="FONT-WEIGHT: bold; TEXT-ALIGN: right" class="TableColumns" width="10%" colSpan=1>Date :&nbsp; </TD><TD style="FONT-WEIGHT: bold; COLOR: red; TEXT-ALIGN: left" class="ColLines" width="50%" colSpan=1><asp:TextBox id="txtDate" runat="server" Width="100px" MaxLength="12"></asp:TextBox><asp:RequiredFieldValidator id="RequiredFieldValidator1" runat="server" ValidationGroup="GP" Enabled="False" ErrorMessage="*" ControlToValidate="txtDate"></asp:RequiredFieldValidator><cc1:CalendarExtender id="CalendarExtender2" runat="server" TargetControlID="txtDate" PopupButtonID="txtDate" Format="dd-MM-yyyy"></cc1:CalendarExtender></TD></TR><TR align=right><TD style="FONT-WEIGHT: bold; WIDTH: 20%; TEXT-ALIGN: right" colSpan=2></TD><TD style="FONT-WEIGHT: bold; WIDTH: 30%; COLOR: red; TEXT-ALIGN: left" colSpan=1>&nbsp;&nbsp; </TD><TD style="FONT-WEIGHT: bold; TEXT-ALIGN: right" colSpan=1>&nbsp;</TD><TD style="FONT-WEIGHT: bold; WIDTH: 30%; COLOR: red; TEXT-ALIGN: left" colSpan=1>&nbsp;&nbsp; </TD></TR><TR align=right><TD style="FONT-WEIGHT: bold; WIDTH: 20%; HEIGHT: 15px; TEXT-ALIGN: right" colSpan=2></TD><TD style="FONT-WEIGHT: bold; WIDTH: 30%; COLOR: red; HEIGHT: 15px; TEXT-ALIGN: left" colSpan=1></TD><TD style="FONT-WEIGHT: bold; HEIGHT: 15px; TEXT-ALIGN: right" colSpan=1></TD><TD style="FONT-WEIGHT: bold; WIDTH: 30%; COLOR: red; HEIGHT: 15px; TEXT-ALIGN: left" colSpan=1>&nbsp;</TD></TR><TR align=right><TD style="FONT-WEIGHT: bold; COLOR: red; HEIGHT: 26px; TEXT-ALIGN: center" colSpan=5></TD></TR><TR align=right></TR><TR align=right></TR></TBODY></TABLE>
</contenttemplate>
                    </asp:UpdatePanel>
                </td>
            </tr>
