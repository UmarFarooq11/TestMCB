<%@ Page Language="C#" MasterPageFile="~/MasterPage/RoutinePage.master" AutoEventWireup="true" CodeFile="LOV_PrintAgentDetail_Location.aspx.cs" Inherits="LOV_LOV_PrintAgentDetail_Location" Title = "Print Agent Location - LOV" %>
<%@ Register
...
// ]]>
    ...
    <asp:Label ID="Label1" runat="server" Font-Names="Trebuchet MS" Font-Size="20pt"
        SkinID="Heading" Text="Print Agent Location" Width="100%"></asp:Label>
...
<TABLE style="FONT-SIZE: 8pt; FONT-FAMILY: Verdana" width="100%"><TBODY><TR align=right><TD style="WIDTH: 25%; TEXT-ALIGN: right">Print Location :&nbsp;
</TD><TD style="WIDTH: 25%; TEXT-ALIGN: left">&nbsp;<asp:TextBox id="TXT_PRINT_LOCATION_ID" runat="server" Width="200px" SkinID="TXT"></asp:TextBox> </TD>
...
<Items>
<eo:ToolBarItem ImageUrl="00101001" ToolTip="Add New" Disabled="True" Visible="False" CommandName="Cancel"></eo:ToolBarItem>
<eo:ToolBarItem ImageUrl="00101032" ToolTip="Search" Disabled="True" CommandName="Cancel"></eo:ToolBarItem>
<eo:ToolBarItem ImageUrl="~/images/Refresh copy.gif" ToolTip="Refresh" Disabled="True" CommandName="Cancel"></eo:ToolBarItem>
</Items>
<ItemTemplates>
...
<ItemTemplate>
<asp:ImageButton id="ImageButton1" onclick="ImageButton1_Click" runat="server" ImageUrl="~/Images/edit1.gif" CommandName="Select" OnClientClick="window.close(); "></asp:ImageButton> 
</ItemTemplate>
</asp:TemplateField>
</Columns>
...
<HeaderStyle HorizontalAlign="Left"></HeaderStyle>
    ...
    <asp:ObjectDataSource ID="SP_SPDS_PrintAgentDetail_ALL" runat="server" OldValuesParameterFormatString="original_{0}"
        SelectMethod="Get_SP_SPDS_PrintAgentDetail_LOV" TypeName="LOV_COLLECTION">
        <SelectParameters>
            <asp:SessionParameter DefaultValue="0" Name="PrintAgentID" SessionField="SPDS_PrintAgentSetup_ID"
                Type="String" />
            <asp:SessionParameter DefaultValue="%" Name="PrintLocationID" SessionField="SPDS_PrintAgentDetail_PRINT_LOCATION_ID"
                Type="String" />
        </SelectParameters>
