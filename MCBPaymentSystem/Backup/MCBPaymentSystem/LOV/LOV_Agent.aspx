<%@ Page Language="C#" MasterPageFile="~/MasterPage/RoutinePage.master" AutoEventWireup="true" CodeFile="LOV_Agent.aspx.cs" Inherits="LOV_Agent" Title = "Agent-LOV" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <asp:Label ID="Label1" runat="server" Font-Names="Trebuchet MS" Font-Size="20pt"
        SkinID="Heading" Text="Agent Setup" Width="100%"></asp:Label>
...
<TABLE style="FONT-SIZE: 8pt; FONT-FAMILY: Verdana" width="100%"><TBODY><TR align=right><TD style="WIDTH: 25%; TEXT-ALIGN: right" class="ColLines1">
    Agent&nbsp;Code :</TD><TD style="WIDTH: 25%; TEXT-ALIGN: left">&nbsp;<asp:TextBox id="TXT_AgentCode" runat="server" Width="200px" SkinID="TXT" MaxLength="5"></asp:TextBox> </TD><TD style="WIDTH: 25%; TEXT-ALIGN: right" class="ColLines1">
    Agent&nbsp;Name :</TD><TD style="WIDTH: 25%; TEXT-ALIGN: left">&nbsp;<asp:TextBox id="TXT_AgentName" runat="server" Width="200px" SkinID="TXT" MaxLength="50"></asp:TextBox> </TD></TR></TBODY></TABLE>
</ContentTemplate>
...
<ContentTemplate>
<TABLE style="FONT-SIZE: 8pt; FONT-FAMILY: Verdana" width="100%"><TBODY><TR><TD style="WIDTH: 25%; TEXT-ALIGN: center"><asp:RadioButton id="RD_BankName" runat="server" Text="Bank Name" GroupName="A"></asp:RadioButton> </TD></TR><TR></TR></TBODY></TABLE><uc1:AlphaSelection id="AlphaSelection1" runat="server"></uc1:AlphaSelection> 
</ContentTemplate>
</ajaxToolkit:TabPanel>
...
<Columns>
<asp:BoundField DataField="COMPANY_CODE" HeaderText="Agent Code" SortExpression="COMPANY_CODE"></asp:BoundField>
<asp:BoundField DataField="COMPANY_NAME" HeaderText="Agent Name" SortExpression="COMPANY_NAME"></asp:BoundField>
...
<HeaderStyle HorizontalAlign="Left"></HeaderStyle>
    ...
    <asp:ObjectDataSource ID="PS_SP_Agent_LOV" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Get_PS_SP_Agent_LOV" TypeName="LOV_COLLECTION">
