<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LOV_FILE.aspx.cs" Inherits="Forms_LOV_Bank" Title="List of Activity Ref. No."%>
...
<head runat="server">
    <title>Selection of Activity Ref. No.</title>
</head>
<body>
    ...
    <div>
        &nbsp;
                <asp:GridView ID="grvBank" runat="server" AutoGenerateColumns="False" CellPadding="4"
                    ...
                    OnRowCommand="grvBank_RowCommand" OnRowDataBound="grvBank_RowDataBound" Width="303px" DataKeyNames="FILE_NAME">
