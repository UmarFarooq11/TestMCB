...
public partial class LOV_Agent : System.Web.UI.Page
{
    ...
    {
            Session["AgentCode"] = GridView1.SelectedRow.Cells[1].Text;
            Session["AgentName"] = GridView1.SelectedRow.Cells[2].Text;
    }
    private void AlphaSelection1_CK(object sender, EventArgs e)
    {
        ...
        {
            Session["AgentCode"] = '%';
            Session["AgentName"] = AlphaSelection1.AlphaClick + '%';
        }
    }
    ...
    protected void ToolBar1_ItemClick(object sender, EO.Web.ToolBarEventArgs e)
    {
        ...
        {
            Session["AgentCode"] = "%" + TXT_AgentCode.Text + "%";
            Session["AgentName"] = "%" + TXT_AgentName.Text + "%";
        }
