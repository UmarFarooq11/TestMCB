<%@ Page Language="C#" AutoEventWireup="true"
    CodeFile="OLD_LOV_FILENAME.aspx.cs" Inherits="TehsilSetup_frmCMN_Tehsil" Title="Tehsil Setup - LOV" %>
...
// ]]>
                        ...
                        <td style="font-size: 9pt; color: #444444; font-family: Arial, Tahoma; text-align: left;
                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="FILE_NAME" HeaderText="FILE NAME" SortExpression="FILE NAME" />
    ...
    <asp:ObjectDataSource ID="sp_filename_who" runat="server" OldValuesParameterFormatString="original_{0}"
