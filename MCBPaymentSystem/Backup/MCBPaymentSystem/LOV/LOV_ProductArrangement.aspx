<%@ Page Language="C#" MasterPageFile="~/MasterPage/RoutinePage.master" AutoEventWireup="true" CodeFile="LOV_ProductArrangement.aspx.cs" Inherits="CustomerProductArrangement_frmSPDS_ProductArrangement" Title = "Customer Product Arrangement - LOV" %>
<%@ Register
...
Text="Customer Product Arrangement" Width="100%" SkinID="Heading"></asp:Label>
...
<ContentTemplate>
<TABLE style="FONT-SIZE: 8pt; FONT-FAMILY: Verdana" width="100%"><TBODY><TR align=right><TD style="WIDTH: 25%; TEXT-ALIGN: right">Customer Name :&nbsp; </TD><TD style="WIDTH: 25%; TEXT-ALIGN: left">&nbsp;<asp:TextBox id="TXT_CustomerName" runat="server" SkinID="TXT" Width="200px"></asp:TextBox> </TD><TD style="WIDTH: 25%; TEXT-ALIGN: right">Product Name :&nbsp; </TD><TD style="WIDTH: 25%; TEXT-ALIGN: left">&nbsp;<asp:TextBox id="TXT_ProductName" runat="server" SkinID="TXT" Width="200px"></asp:TextBox> </TD></TR></TBODY></TABLE>
</ContentTemplate>
...
<ContentTemplate>
<TABLE style="FONT-SIZE: 8pt; FONT-FAMILY: Verdana" width="100%"><TBODY><TR><TD style="WIDTH: 25%; TEXT-ALIGN: center"><asp:RadioButton id="RD_CustomerName" runat="server" Text="Customer Name" GroupName="A"></asp:RadioButton> </TD><TD style="WIDTH: 25%; TEXT-ALIGN: center"><asp:RadioButton id="RD_ProductName" runat="server" Text="Product Name" GroupName="A"></asp:RadioButton> </TD></TR><TR></TR></TBODY></TABLE><uc1:AlphaSelection id="AlphaSelection1" runat="server"></uc1:AlphaSelection> 
</ContentTemplate>
</ajaxToolkit:TabPanel>
...
<asp:BoundField DataField="CorrespondentBankName" HeaderText="Correspondent Name" SortExpression="CorrespondentBankName"></asp:BoundField>
<asp:BoundField DataField="CourierName" HeaderText="Courier Name" SortExpression="CourierName"></asp:BoundField>
<asp:BoundField DataField="Isonline" HeaderText="Is Online" SortExpression="Isonline"></asp:BoundField>
<asp:BoundField DataField="ServiceID" HeaderText="Service Time" SortExpression="ServiceID"></asp:BoundField>
<asp:BoundField DataField="Authorization" HeaderText="Authorization" SortExpression="Authorization"></asp:BoundField>
...
<HeaderStyle HorizontalAlign="Left"></HeaderStyle>
    ...
    <asp:ObjectDataSource ID="SP_SPDS_ProductArrangement_LOV" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Get_SPDS_ProductArrangement_LOV" TypeName="LOV_COLLECTION">
        <SelectParameters>
            <asp:SessionParameter DefaultValue="%" Name="CustomerName" SessionField="SPDS_ProductArrangement_CustomerName"
                Type="String" />
            <asp:SessionParameter DefaultValue="%" Name="ProductName" SessionField="SPDS_ProductArrangement_ProductName"
                Type="String" />            
        </SelectParameters>
