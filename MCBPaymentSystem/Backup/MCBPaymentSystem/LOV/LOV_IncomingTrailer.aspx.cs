...
public partial class LOV_Batch : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (IsPostBack == false)
        {
            ...
            Session["BatchDate"] = "";
            Session["BatchNumber"] = "";
            Session["BatchesToThisDate"] = "";
            Session["LastBatchNumber"] = "";
            Session["RecordsToDate"] = "";
            Session["CurrencyCode"] = "";
            Session["TotalCoverAmountToDate"] = "";
        }
    }
    ...
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Session["BatchDate"] = GridView1.SelectedRow.Cells[3].Text;
        Session["BatchNumber"] = GridView1.SelectedRow.Cells[4].Text;
        Session["BatchesToThisDate"] = GridView1.SelectedRow.Cells[5].Text;
        Session["LastBatchNumber"] = GridView1.SelectedRow.Cells[6].Text;
        Session["RecordsToDate"] = GridView1.SelectedRow.Cells[7].Text;
        Session["CurrencyCode"] = GridView1.SelectedRow.Cells[8].Text;
        Session["TotalCoverAmountToDate"] = GridView1.SelectedRow.Cells[9].Text;
    }
