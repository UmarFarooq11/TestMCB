...
public partial class TehsilSetup_frmCMN_Tehsil : System.Web.UI.Page
{
    ...
    {
        Session["CMN_Tehsil_TehsilCode"] = GridView1.SelectedRow.Cells[1].Text;
        Session["CMN_Tehsil_TehsilName"] = GridView1.SelectedRow.Cells[2].Text;
    ...
    private void AlphaSelection1_CK(object sender, EventArgs e)
    {
        ...
        if (RD_TehsilName.Checked == true)
        {
            Session["CMN_Tehsil_TehsilCode"] = '%';
            Session["CMN_Tehsil_TehsilName"] = AlphaSelection1.AlphaClick + '%';
        }
    }
    ...
    protected void ToolBar1_ItemClick(object sender, EO.Web.ToolBarEventArgs e)
    {
        ...
        {
            Session["CMN_Tehsil_TehsilCode"] = "%" + TXT_TehsilCode.Text + "%";
            Session["CMN_Tehsil_TehsilName"] = "%" + TXT_TehsilName.Text + "%";
        }
