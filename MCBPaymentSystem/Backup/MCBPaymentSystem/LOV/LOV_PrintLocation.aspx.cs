...
public partial class DistrictSetup_frmCMN_District : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (IsPostBack==false)
        {
            ...
            Session["PrintLocationID"] = "0";
            Session["PrintLocationName"] = "0";
            Session["CMN_Province_ID"] = "1";
            Session["LOV_ID"] = "";
    ...
    {
        Session["PrintLocationID"] = GridView1.SelectedRow.Cells[0].Text;
        Session["PrintLocationName"] = GridView1.SelectedRow.Cells[1].Text;
    ...
    private void AlphaSelection1_CK(object sender, EventArgs e)
    {
        ...
        if (RD_DistrictName.Checked == true)
        {
            Session["PrintLocationName"] = AlphaSelection1.AlphaClick + '%';
        }
    }
