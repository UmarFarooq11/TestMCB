<%--<%@ Page Language="C#" MasterPageFile="~/MasterPage/RoutinePage.master" AutoEventWireup="true" CodeFile="LOV_Country.aspx.cs" Inherits="COUNTRY_SETUP_frmCMN_Country" Title = "Country Setup" %>--%>

<%@ Page Language="C#" MasterPageFile="~/MasterPage/RoutinePage.master" AutoEventWireup="true" CodeFile="LOV_Country.aspx.cs" Inherits="COUNTRY_SETUP_frmCMN_Country"
    Title="Country Setup - LOV" %>
...
--%>        <%--<asp:content id="Content1" contentplaceholderid="ContentPlaceHolder1" runat="Server">--%>
    ...
    <asp:Label ID="Label1" runat="server" Font-Names="Trebuchet MS" Font-Size="20pt"
        SkinID="Heading" Text="Country Setup" Width="100%"></asp:Label>
                            ...
                            <table style="font-size: 8pt; font-family: Verdana" width="100%">
                                <tr align="right">
                                    ...
                                    <td style="width: 25%; text-align: left">
                                        &nbsp;<asp:TextBox ID="TXT_SBPCode" runat="server" Width="200px" MaxLength="4" SkinID="TXT"></asp:TextBox>&nbsp;
                                       <%-- <ajaxToolkit:FilteredTextBoxExtender
                                            ID="FilteredTextBoxExtender1" runat="server" FilterType="Numbers" TargetControlID="TXT_SBPCode">
                                        </ajaxToolkit:FilteredTextBoxExtender>--%>
                                         <ajaxToolkit:FilteredTextBoxExtender ID="FTE_TXT_SBPCode" runat="server" FilterType="Custom"
        TargetControlID="TXT_SBPCode" FilterMode="ValidChars" Enabled="true" ValidChars="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz">
    </ajaxToolkit:FilteredTextBoxExtender>
                                    ...
                                    <td style="width: 25%; text-align: left">
                                        &nbsp;<asp:TextBox ID="TXT_CountryName" runat="server" Width="200px" MaxLength="50" SkinID="TXT"></asp:TextBox></td>
                                </tr>
                            </table>
                        </ContentTemplate>
                            ...
                            <table style="font-size: 8pt; font-family: Verdana" width="100%">
                                <tr>
                                    <td style="width: 25%; text-align: center">
                                        <asp:RadioButton ID="RD_CountryName" runat="server" GroupName="A" Text="Country Name" /></td>
                                </tr>
                                <tr>
                                </tr>
                            </table>
                ...
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                    ...
                    PageSize="20" ShowFooter="True" Style="width: 100%" Width="100%" DataSourceID="SP_CMN_Country_ALL">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="SBPCode" HeaderText="Country Code" SortExpression="SBPCode" />
        ...
        <asp:ObjectDataSource ID="SP_CMN_Country_ALL" runat="server" OldValuesParameterFormatString="original_{0}"
            SelectMethod="Get_CMN_Country_LOV" TypeName="LOV_COLLECTION">
            <SelectParameters>
                <asp:SessionParameter DefaultValue="%" Name="SBPCode" SessionField="CMN_Country_SBPCode"
                    Type="String" />
                <asp:SessionParameter DefaultValue="%" Name="CountryName" SessionField="CMN_Country_CountryName"
                    Type="String" />
            </SelectParameters>
