<%@ Page Language="C#" MasterPageFile="~/MasterPage/RoutinePage.master" AutoEventWireup="true"
    CodeFile="DataLoadCofiguration.aspx.cs" Inherits="DataLoadCofiguration" Title="Data Load Configuration" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Label ID="Label1" runat="server" Font-Names="Trebuchet MS" Font-Size="20pt"
        Text="Data Load Configuration" Width="100%" SkinID="Heading"></asp:Label>
...
<ContentTemplate>
<TABLE style="FONT-SIZE: 8pt; FONT-FAMILY: Verdana" width="100%"><TBODY><TR align=right><TD style="WIDTH: 25%; TEXT-ALIGN: right">Configuration ID:</TD><TD style="WIDTH: 25%; TEXT-ALIGN: left"><asp:TextBox id="TXT_ConfigurationID" runat="server" SkinID="TXT" Width="108px" __designer:wfdid="w37" MaxLength="10"></asp:TextBox> </TD><TD style="WIDTH: 25%; TEXT-ALIGN: right">Configuration Name:</TD><TD style="WIDTH: 25%; TEXT-ALIGN: left"><asp:TextBox id="TXT_ConfigurationName" runat="server" SkinID="TXT" Width="200px" __designer:wfdid="w36" MaxLength="30"></asp:TextBox> </TD></TR></TBODY></TABLE>
</ContentTemplate>
...
<ContentTemplate>
<TABLE style="FONT-SIZE: 8pt; FONT-FAMILY: Verdana" width="100%"><TBODY><TR><TD style="WIDTH: 25%; TEXT-ALIGN: center"><asp:RadioButton id="RD_ConfigurationName" runat="server" Text="Configuration Name" __designer:wfdid="w33" GroupName="A"></asp:RadioButton> </TD></TR></TBODY></TABLE><uc1:AlphaSelection id="AlphaSelection1" runat="server" __designer:wfdid="w34"></uc1:AlphaSelection> 
</ContentTemplate>
</ajaxToolkit:TabPanel>
        ...
        </eo:ToolBar>--%><TABLE cellSpacing=0 width="100%"><TBODY><TR><TD style="WIDTH: 240px; HEIGHT: 26px"><asp:Button id="BTN_SEARCH" onclick="BTN_SEARCH_Click" runat="server" Text="Search" Font-Size="10pt" Font-Names="Verdana" Font-Bold="True"></asp:Button> <asp:Button id="BTN_CLEAR" onclick="BTN_CLEAR_Click" runat="server" Text="Clear" Font-Size="10pt" Font-Names="Verdana" Font-Bold="True"></asp:Button> <asp:Button id="BTN_NEW" onclick="BTN_NEW_Click" runat="server" Text="New" Font-Size="10pt" Font-Names="Verdana" CssClass="BTN" Font-Bold="True"></asp:Button> </TD></TR></TBODY></TABLE><TABLE class="login" cellSpacing=0 width="100%"><TBODY><TR><TD><asp:Label style="FONT-WEIGHT: bold; FONT-SIZE: 9pt; FONT-FAMILY: Arial, Tahoma" id="LBL_GridStatus" runat="server" SkinID="LBL_STATUS" Width="100px"></asp:Label></TD><TD><asp:Label style="FONT-WEIGHT: bold; FONT-SIZE: 10pt; FONT-FAMILY: Arial, Tahoma" id="LBL_RowStatus" runat="server" SkinID="LBL_STATUS" Width="200px"></asp:Label></TD><TD style="TEXT-ALIGN: center" width="100%"><asp:UpdateProgress id="UpdateProgress1" runat="server">
                <ProgressTemplate>
...
<asp:BoundField DataField="conf_desc" HeaderText="Description" SortExpression="conf_desc">
<HeaderStyle HorizontalAlign="Left"></HeaderStyle>
...
<asp:BoundField DataField="fileseparate" HeaderText="File Separate" SortExpression="fileseparate"></asp:BoundField>
...
<HeaderStyle HorizontalAlign="Left"></HeaderStyle>
    ...
    <asp:ObjectDataSource ID="SP_SPDS_DataLoadCofiguration_ALL" runat="server" OldValuesParameterFormatString="original_{0}"
        SelectMethod="Get_SPDS_DataLoadCofiguration_ALL" TypeName="LOV_COLLECTION">
        <SelectParameters>
            <asp:SessionParameter DefaultValue="%" Name="ConfigurationID" SessionField="SPDS_DataLoad_ConfigurationID"
                Type="String" />
            <asp:SessionParameter DefaultValue="%" Name="ConfigurationName" SessionField="SPDS_DataLoad_ConfigurationName"
                Type="String" />
        </SelectParameters>
