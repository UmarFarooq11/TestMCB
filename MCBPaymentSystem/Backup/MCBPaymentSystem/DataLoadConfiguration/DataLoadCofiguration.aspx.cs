...
public partial class DataLoadCofiguration : System.Web.UI.Page
{
    string[] ARY;
    string RGS_SUPPORT;
    ...
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            Session["SPDS_DataLoadDefinationCofiguration_ID"] = GridView1.DataKeys[this.GridView1.SelectedIndex].Value.ToString();
            Session["SPDS_DataLoadCofiguration_ID"]           = GridView1.SelectedRow.Cells[0].Text;
            Session["Configuration_ID"]                       = GridView1.SelectedRow.Cells[0].Text;
            Session["FormMode"] = "EDIT";
            Response.Redirect("../DataLoadConfiguration/DataLoadCofigurationSPC.aspx" + "?" + "s1=" + Request.QueryString[0].ToString());
        }
    }
    private void AlphaSelection1_CK(object sender, EventArgs e)
    {
        ...
        {
            Session["SPDS_DataLoad_ConfigurationID"] = "%";
            Session["SPDS_DataLoad_ConfigurationName"] = AlphaSelection1.AlphaClick + '%';
        }
    }
    ...
    //    {
    //        Session["SPDS_DataLoad_ConfigurationID"] = "%" + TXT_ConfigurationID.Text + "%";
    //        Session["SPDS_DataLoad_ConfigurationName"] = "%" + TXT_ConfigurationName.Text + "%";
    //    }
    //    else if (e.Item.ToolTip == "Refresh")
    //    {
    //        TXT_ConfigurationName.Text = "";
    //        TXT_ConfigurationID.Text = "";
    //    }
    //}
