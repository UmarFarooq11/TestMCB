...
public partial class CustomerSetup_CustomerSetup : System.Web.UI.Page
{
    string[] ARY;
    string RGS_SUPPORT;
    ...
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            Session["RPS_Bank_ID"] = GridView1.DataKeys[this.GridView1.SelectedIndex].Value.ToString();
            Session["RPS_Bank_BankCode"] = GridView1.SelectedRow.Cells[1].Text;
            Session["RPS_Bank_BankName"] = GridView1.SelectedRow.Cells[2].Text;
            Session["RPS_Bank_AccountNo"] = GridView1.SelectedRow.Cells[3].Text;
