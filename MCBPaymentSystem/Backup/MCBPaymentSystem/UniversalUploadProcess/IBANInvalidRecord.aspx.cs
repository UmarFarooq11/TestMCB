...
public partial class IBANInvalidRecord : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Get_InvalidData(company_code, file_name);
    ...
    public DataSet Get_InvalidData(string CompanyCode, string filename)
    {
        ...
        ds = _dbConfig.Oracle_GetDataSetSP("sp_get_iban_invalid_records", PR);
