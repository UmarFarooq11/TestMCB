...
public partial class LOV_LOV_PrintAgentDetail : System.Web.UI.Page
{
    ...
    {
        if (RD_PRINT_AGENT_ID.Checked == true)
        {
            Session["SPDS_PrintAgentDetail_PRINT_AGENT_ID"] = AlphaSelection1.AlphaClick + '%';
            Session["SPDS_PrintAgentDetail_PRINT_LOCATION_ID"] = '%';
            //Session["SPDS_PrintAgentDetail_DONGAL_PIN"] = '%';
            //Session["VMASTER_ZIP_CODE"] = '%';
        }
