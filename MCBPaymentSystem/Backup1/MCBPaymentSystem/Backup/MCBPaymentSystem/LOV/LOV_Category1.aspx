<%@ Page Language="C#" MasterPageFile="~/MasterPage/RoutinePage.master" AutoEventWireup="true" CodeFile="LOV_Category1.aspx.cs" Inherits="LOV_LOV_Category1" Title="Signatory Category Setup - LOV" %>
  <%@ Register
...
Text="Signatory Category Setup" Width="100%" SkinID="Heading"></asp:Label>
...
<TABLE style="FONT-SIZE: 8pt; FONT-FAMILY: Verdana" width="100%"><TBODY><TR align=right><TD style="WIDTH: 25%; TEXT-ALIGN: right">Category Name :&nbsp;
</TD><TD style="WIDTH: 25%; TEXT-ALIGN: left">
    &nbsp;<asp:TextBox id="TXT_CATEGORY_NAME" runat="server" Width="200px" MaxLength="50" SkinID="TXT"></asp:TextBox> </TD></TR></TBODY></TABLE>
</ContentTemplate>
<HeaderTemplate>
Basic Search
</HeaderTemplate>
...
<table style="font-size: 8pt; font-family: Verdana" width="100%">
                        <tr>
                            <td style="width: 25%; text-align: center">
                                <asp:RadioButton ID="RD_CATEGORY_NAME" runat="server" GroupName="A" Text="Category Name"  /></td>
                            <td style="width: 25%; text-align: center">
                                <asp:RadioButton ID="RD_FROM_LIMIT" runat="server" GroupName="A" Text="From Limit"  /></td>
                            <td style="width: 25%; text-align: center">
                                <asp:RadioButton ID="RD_TO_LIMIT" runat="server" GroupName="A" Text="To Limit"  /></td>
                            <td style="width: 25%; text-align: center">
                                <asp:RadioButton ID="RD_CurrentStatus" runat="server" GroupName="A" Text="Current Status"  /></td>
                        </tr>
                        <tr>
                        </tr>
                        <tr>
...
<asp:BoundField DataField="CATEGORY_NAME" SortExpression="CATEGORY_NAME" HeaderText="Category Name"></asp:BoundField>
...
<HeaderStyle HorizontalAlign="Left"></HeaderStyle>
    ...
    <asp:ObjectDataSource ID="SP_SPDS_SignatoryCategorySetup_ALL" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Get_SPDS_SignatoryCategorySetup_LOV_ALL" TypeName="LOV_COLLECTION">
        <SelectParameters>
            <asp:SessionParameter DefaultValue="0" Name="CATEGORY_NAME" SessionField="SPDS_SignatoryCategorySetup_CATEGORY_NAME"
                Type="String" />
        </SelectParameters>
