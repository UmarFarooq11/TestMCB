<%@ Page Language="C#" Theme="ColorSchemeBlue" AutoEventWireup="true" CodeFile="LOV_REMETTER_NAME.aspx.cs"
        ...
        <contenttemplate>
                ...
                <table cellspacing="0" style="font-size: 10pt; background-color: #f6f6f6" width="100%">
                    ...
                    OnSelectedIndexChanged="GridView1_SelectedIndexChanged" PageSize="20" ShowFooter="True"
                      DataKeyNames="FIRSTNAME" DataSourceID="sp_REMETTERNAME_LOV"
                    ...
                    <Columns>
                        <asp:BoundField DataField="FIRSTNAME" HeaderText="REMITTER Name" SortExpression="REMITTER_NAME" />
                    ...
                    <PagerStyle BorderColor="#404040" BorderStyle="Solid" />
                            ...
                            <asp:ObjectDataSource ID="sp_REMETTERNAME_LOV" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="LOV_REMITTERName" TypeName="LOV_COLLECTION">
                    <SelectParameters>
