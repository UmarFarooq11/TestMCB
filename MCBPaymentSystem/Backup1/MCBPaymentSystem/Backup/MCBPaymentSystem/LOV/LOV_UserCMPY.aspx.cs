...
public partial class LOV_LOV_UserCMPY : System.Web.UI.Page
{
    ...
    private void AlphaSelection1_CK(object sender, EventArgs e)
    {
        ...
        {
            Session["USER_SEARCH"] = AlphaSelection1.AlphaClick + '%';
        }
    }
