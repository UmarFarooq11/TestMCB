<%@ Page Language="C#" MasterPageFile="~/MasterPage/RoutinePage.master" AutoEventWireup="true" CodeFile="LOV_Branch.aspx.cs" Inherits="BranchSetup_frmCMN_Branch" Title = "Branch Setup - LOV" %>
...
<ContentTemplate>
<TABLE style="FONT-SIZE: 8pt; FONT-FAMILY: Verdana" width="100%"><TBODY><TR align=right><TD style="WIDTH: 25%; TEXT-ALIGN: right">Branch Code :&nbsp; </TD><TD style="WIDTH: 25%; TEXT-ALIGN: left">&nbsp;<asp:TextBox id="TXT_BranchCode" runat="server" Width="200px" SkinID="TXT"></asp:TextBox> </TD><TD style="WIDTH: 25%; TEXT-ALIGN: right">Branch Name :&nbsp; </TD><TD style="WIDTH: 25%; TEXT-ALIGN: left">&nbsp;<asp:TextBox id="TXT_BranchName" runat="server" Width="200px" SkinID="TXT"></asp:TextBox> </TD></TR></TBODY></TABLE>
</ContentTemplate>
...
<PagerStyle BorderColor="#404040" BorderStyle="Solid"></PagerStyle>
    ...
    <asp:ObjectDataSource ID="SP_CMN_Branch_ALL" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Get_CMN_Branch_LOV" TypeName="LOV_COLLECTION">
        <SelectParameters>
            <asp:SessionParameter DefaultValue="%" Name="BranchCode" SessionField="CMN_Branch_BranchCode"
                Type="String" />
            <asp:SessionParameter DefaultValue="%" Name="BranchName" SessionField="CMN_Branch_BranchName"
                Type="String" />
        </SelectParameters>
