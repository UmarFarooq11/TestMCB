...
public partial class COUNTRY_SETUP_frmCMN_Country : System.Web.UI.Page
{
    ...
    {
        Session["CMN_Country_SBPCode"] = GridView1.DataKeys[this.GridView1.SelectedIndex].Value.ToString();
        Session["CMN_Country_CountryName"] = GridView1.SelectedRow.Cells[2].Text;
    ...
    private void AlphaSelection1_CK(object sender, EventArgs e)
    {
        ...
        if (RD_CountryName.Checked == true)
        {
            Session["CMN_Country_SBPCode"] = '%';
            Session["CMN_Country_CountryName"] = AlphaSelection1.AlphaClick + '%';
        }
    }
    ...
    protected void ToolBar1_ItemClick(object sender, EO.Web.ToolBarEventArgs e)
    {
        ...
        {
            Session["CMN_Country_SBPCode"] = "%" + TXT_SBPCode.Text + "%";
            Session["CMN_Country_CountryName"] = "%" + TXT_CountryName.Text + "%";
        }
