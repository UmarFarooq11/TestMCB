...
public partial class SignatorySetup_frmSPDS_SignatorySetup : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
          ...
          if (IsPostBack == false)
          {
              ...
              Session["SPDS_SignatorySetup_SIGNATORY_NAME"] = "0";
    ...
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
            ...
            Session["LOV_CODE"] = GridView1.DataKeys[this.GridView1.SelectedIndex].Value.ToString();
            Session["LOV_DESCRIPTION"] = GridView1.SelectedRow.Cells[1].Text;
            Response.Redirect("../SignatorySetup/frmSPDS_SignatorySetupSPC.aspx");
    }
