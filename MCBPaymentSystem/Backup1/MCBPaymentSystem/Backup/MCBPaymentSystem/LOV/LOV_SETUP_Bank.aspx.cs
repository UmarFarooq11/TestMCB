...
public partial class CustomerSetup_LOV_Customer : System.Web.UI.Page
{
    ...
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
            ...
            Session["BankCode"] = GridView1.SelectedRow.Cells[1].Text;
            Session["BankName"] = GridView1.SelectedRow.Cells[2].Text;
    ...
    private void AlphaSelection1_CK(object sender, EventArgs e)
    {
        ...
        {
            Session["BankCode"] = '%';
            Session["BankName"] = AlphaSelection1.AlphaClick + '%';
        }
    }
    ...
    protected void ToolBar1_ItemClick(object sender, EO.Web.ToolBarEventArgs e)
    {
        ...
        {
            Session["BankCode"] = "%" + TXT_BankCode.Text + "%";
            Session["BankName"] = "%" + TXT_BankName.Text + "%";
        }
