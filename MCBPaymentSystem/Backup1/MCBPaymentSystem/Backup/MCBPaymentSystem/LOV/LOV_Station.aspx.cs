...
public partial class CourierStationSetup_frmCMN_Station : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (IsPostBack == false)
        {
            Session["StationCode"] = "0";
            Session["StationName"] = "0";
            Session["LOV_ID"] = "";
            Session["LOV_CODE"] = "";
    ...
    {
        Session["CMN_Station_ID"] = GridView1.DataKeys[this.GridView1.SelectedIndex].Value.ToString();
        Session["CMN_Station_StationCode"] = GridView1.SelectedRow.Cells[1].Text;
        Session["CMN_Station_StationName"] = GridView1.SelectedRow.Cells[2].Text;
    ...
    private void AlphaSelection1_CK(object sender, EventArgs e)
    {
        ...
        if (RD_StationName.Checked == true)
        {
            Session["CMN_Station_StationCode"] = '%';
            Session["CMN_Station_StationName"] = AlphaSelection1.AlphaClick + '%';
        }
    }
    ...
    protected void ToolBar1_ItemClick(object sender, EO.Web.ToolBarEventArgs e)
    {
       ...
       if (e.Item.ToolTip == "Search")
        {
            Session["CMN_Station_StationCode"] = "%" + TXT_StationCode.Text + "%";
            Session["CMN_Station_StationName"] = "%" + TXT_StationName.Text + "%";
        }
