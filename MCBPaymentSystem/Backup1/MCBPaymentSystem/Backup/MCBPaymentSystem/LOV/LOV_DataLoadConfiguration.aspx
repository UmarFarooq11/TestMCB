<%@ Page Language="C#" MasterPageFile="~/MasterPage/RoutinePage.master" AutoEventWireup="true"
    CodeFile="LOV_DataLoadConfiguration.aspx.cs" Inherits="LOV_DataLoadConfiguration"
    Title="Configuration ID - LOV" %>
...
// ]]>
    ...
    <asp:Label ID="Label1" runat="server" Font-Names="Trebuchet MS" Font-Size="20pt"
        Text="Configuration ID" Width="100%" SkinID="Heading"></asp:Label><asp:UpdatePanel
...
<ContentTemplate>
<TABLE style="FONT-SIZE: 8pt; FONT-FAMILY: Verdana" width="100%"><TBODY><TR align=right><TD style="WIDTH: 25%; TEXT-ALIGN: right">Configuration ID&nbsp;:&nbsp; </TD><TD style="WIDTH: 25%; TEXT-ALIGN: left">&nbsp;<asp:TextBox id="TXT_DraftNo" runat="server" SkinID="TXT" Width="200px" __designer:wfdid="w285"></asp:TextBox> </TD></TR></TBODY></TABLE>
</ContentTemplate>
...
<ContentTemplate>
<TABLE style="FONT-SIZE: 8pt; FONT-FAMILY: Verdana" width="100%"><TBODY><TR><TD style="WIDTH: 25%; TEXT-ALIGN: center"><asp:RadioButton id="RD_DraftNo" runat="server" Text="Description" __designer:wfdid="w282" GroupName="A"></asp:RadioButton> </TD></TR><TR></TR></TBODY></TABLE><uc1:AlphaSelection id="AlphaSelection1" runat="server" __designer:wfdid="w283"></uc1:AlphaSelection> 
</ContentTemplate>
</ajaxToolkit:TabPanel>
...
<HeaderStyle HorizontalAlign="Left"></HeaderStyle>
    ...
    <asp:ObjectDataSource ID="SP_RPS_Configuration_ALL" runat="server" OldValuesParameterFormatString="original_{0}"
        SelectMethod="Get_RPS_LOV_DataConfiguration_ALL" TypeName="LOV_COLLECTION">
        <SelectParameters>
            <asp:SessionParameter DefaultValue="%" Name="P_CONF_ID" SessionField="SPDS_LOV_CONF_ID"
                Type="String" />
            <asp:SessionParameter DefaultValue="%" Name="P_CONF_DESC" SessionField="SPDS_LOV_CONFIF_DESC"
                Type="String" />
        </SelectParameters>
