...
public partial class ProductMasterSetup_frmSPDS_ProductMaster : System.Web.UI.Page
{
    ...
    private void AlphaSelection1_CK(object sender, EventArgs e)
    {
        ...
        {
            Session["SPDS_ProductMaster_ProductCode"] = '%';
            Session["SPDS_ProductMaster_ProductName"] = AlphaSelection1.AlphaClick + '%';
        }
    }
