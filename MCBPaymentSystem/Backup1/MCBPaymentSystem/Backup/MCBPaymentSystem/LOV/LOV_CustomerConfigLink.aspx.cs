...
public partial class LOV_CustomerConfigLink : System.Web.UI.Page
{
    ...
    {
        Session["CONF_DEF_ID"]    = GridView1.SelectedRow.Cells[0].Text;
        Session["CONF_DEF_desc"] = GridView1.SelectedRow.Cells[1].Text;
    ...
    private void AlphaSelection1_CK(object sender, EventArgs e)
    {
        ...
        if (RD_ConfigdefDesc.Checked == true)
        {
            Session["CONF_DEF_ID"] = '%';
            Session["CONF_DEF_desc"] = AlphaSelection1.AlphaClick + '%';
        }
    }
