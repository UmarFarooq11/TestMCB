...
public partial class UniversalUploadProcess_frmSPDS_UniversalUploadCofiguration : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (IsPostBack == false)
        {
            Session["SPDS_UniversalUploadCofiguration_ID"] = "0";
            Session["SPDS_UniversalUploadCofiguration_Channel"] = "0";
            Session["SPDS_UniversalUploadCofiguration_ConfigurationName"] = "0"; 
            Session["LOV_ID"] = "";
            Session["LOV_CODE"] = "";
    ...
    {
        Session["SPDS_UniversalUploadCofiguration_Channel"] = GridView1.SelectedRow.Cells[1].Text;
        Session["SPDS_UniversalUploadCofiguration_ConfigurationName"] = GridView1.SelectedRow.Cells[2].Text;
        Session["SPDS_UniversalUploadCofiguration_FileFormat"] = GridView1.SelectedRow.Cells[3].Text;
        Session["LOV_ID"] = GridView1.DataKeys[this.GridView1.SelectedIndex].Value.ToString();
        Session["LOV_CODE"] = GridView1.SelectedRow.Cells[0].Text;
    ...
    private void AlphaSelection1_CK(object sender, EventArgs e)
    {
        ...
        if (RD_Channel.Checked == true)
        {
            Session["SPDS_UniversalUploadCofiguration_Channel"] = AlphaSelection1.AlphaClick + '%';
            Session["SPDS_UniversalUploadCofiguration_ConfigurationName"] = '%';
        }
        if (RD_ConfigurationName.Checked == true)
        {
            Session["SPDS_UniversalUploadCofiguration_Channel"] = '%';
            Session["SPDS_UniversalUploadCofiguration_ConfigurationName"] = AlphaSelection1.AlphaClick + '%';
        }
    }
