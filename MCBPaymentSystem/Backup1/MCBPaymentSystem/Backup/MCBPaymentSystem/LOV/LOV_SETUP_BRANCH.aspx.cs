...
public partial class LOV_SETUP_BRANCH : System.Web.UI.Page
{
    ...
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
            ...
            Session["BranchCode"] = GridView1.SelectedRow.Cells[0].Text;
            Session["BranchName"] = GridView1.SelectedRow.Cells[1].Text;
    ...
    private void AlphaSelection1_CK(object sender, EventArgs e)
    {
        ...
        {
            Session["BranchCode"] = '%';
            Session["BranchName"] = AlphaSelection1.AlphaClick + '%';
        }
    }
    ...
    protected void ToolBar1_ItemClick(object sender, EO.Web.ToolBarEventArgs e)
    {
        ...
        {
            Session["BranchCode"] = "%" + TXT_BranchCode.Text + "%";
            Session["BranchName"] = "%" + TXT_BranchName.Text + "%";
        }
