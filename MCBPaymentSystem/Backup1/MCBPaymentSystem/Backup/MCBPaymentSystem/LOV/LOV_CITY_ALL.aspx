<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LOV_CITY_ALL.aspx.cs" Inherits="LOV_LOV_CITY_SETUP" %>
...
<body style="background-repeat: repeat; text-align: left; vertical-align: middle; background-position-x: center; background-attachment: scroll; background-color: #f6f6f6;">
    ...
    <script language="javascript" type="text/javascript">
function City_SetupLOV() 
{
 var a;
  a=window.showModalDialog('../LOV/LOV_CITY_SETUP.aspx',null,'status:no;dialogWidth:550px;dialogHeight:220px;dialogHide:true;help:no;scroll:yes');
}
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                            ...
                            <table style="font-size: 8pt; font-family: Verdana" width="100%">
                                <tr align="right">
                                    ...
                                    <td style="width: 25%; text-align: left">
                                        <asp:TextBox ID="TXT_CITY_CODE" runat="server" Width="200px"></asp:TextBox></td>
                                    <td style="width: 25%; text-align: right">
                                        City Name :
                                    </td>
                                    <td style="width: 25%; text-align: left">
                                        <asp:TextBox ID="TXT_CITYNAME" runat="server" Width="200px"></asp:TextBox>&nbsp;</td>
                                </tr>
                            </table>
                        </ContentTemplate>
                            ...
                            <table style="font-size: 8pt; font-family: Verdana" width="100%">
                                <tr>
                                    <td colspan="2" style="text-align: center">
                                        &nbsp;<asp:RadioButton ID="RD_CITY_CODE" runat="server" GroupName="A" Text="City Code" />&nbsp;</td>
                                    <td style="text-align: center">
                                        &nbsp;<asp:RadioButton ID="RD_CITY_NAME" runat="server" GroupName="A" Text="City Name" /></td>
                                </tr>
                                <tr>
                                </tr>
                            </table>
                ...
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                    AutoGenerateColumns="False" DataKeyNames="FILE_NAME" DataSourceID="LOV_SP_CITY_SETUP_ALL"
                    ...
                    <Columns>
                        <asp:BoundField DataField="FILE_NAME" HeaderText="City Name" SortExpression="FILE_NAME" />
                ...
                <asp:ObjectDataSource ID="LOV_SP_CITY_SETUP_ALL" runat="server" OldValuesParameterFormatString="original_{0}"
                    OnSelected="LOV_SP_CITY_SETUP_ALL_Selected" SelectMethod="getfilename" TypeName="LOV_COLLECTION">
                    <SelectParameters>
