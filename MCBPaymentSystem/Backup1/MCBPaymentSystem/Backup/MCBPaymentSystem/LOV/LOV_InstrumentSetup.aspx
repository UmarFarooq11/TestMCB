<%@ Page Language="C#" MasterPageFile="~/MasterPage/RoutinePage.master" AutoEventWireup="true" CodeFile="LOV_InstrumentSetup.aspx.cs" Inherits="InstrumentSetup_frmSPDS_InstrumentSetup" Title = "Instrument Setup - LOV" %>
<%@ Register
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <asp:Label ID="Label1" runat="server" Font-Names="Trebuchet MS" Font-Size="20pt"
        SkinID="Heading" Text="Instrument Setup" Width="100%"></asp:Label>
<asp:UpdatePanel id="UpdatePanel1" runat="server">
<contenttemplate>
<ajaxToolkit:TabContainer style="FONT-SIZE: 8pt; FONT-FAMILY: Verdana" id="TabContainer1" runat="server" ActiveTabIndex="0" BackColor="#FFFFEE" Font-Names="Verdana" Font-Size="8pt" CssClass="ajax__tab_xp1"><ajaxToolkit:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel1"><HeaderTemplate>
Basic Search
</HeaderTemplate>
<ContentTemplate>
<TABLE style="FONT-SIZE: 8pt; FONT-FAMILY: Verdana" width="100%"><TBODY><TR align=right><TD style="WIDTH: 25%; TEXT-ALIGN: right">Instrument Name :</TD><TD style="WIDTH: 25%; TEXT-ALIGN: left">&nbsp;<asp:TextBox id="TXT_INSTRUMENT_NAME" runat="server" Width="200px" SkinID="TXT"></asp:TextBox> </TD>
...
<PagerStyle BorderColor="#404040" BorderStyle="Solid"></PagerStyle>
    ...
    <asp:ObjectDataSource ID="SP_SPDS_InstrumentSetup_ALL" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Get_SPDS_InstrumentSetup_LOV" TypeName="LOV_COLLECTION">
        <SelectParameters>
