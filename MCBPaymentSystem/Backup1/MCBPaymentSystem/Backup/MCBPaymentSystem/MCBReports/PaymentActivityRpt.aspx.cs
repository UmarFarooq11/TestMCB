...
public partial class PaymentMISViewer : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        string branch_id, Status, fromDate, toDate, selecttype;
        ...
        Generate(branch_id, Status, fromDate, toDate, selecttype);
    }
    private void Generate(string branch_id, string status, string fromDate, string toDate, string selecttype)
    {
        ...
        try
        {
            ...
            temp = GetData(branch_id, status, fromDate, toDate, selecttype);
            if (temp.Rows.Count > 0)
            {
                ReportDataSource rptDataSource = new ReportDataSource
                ("MCB_DataSet_PaymentMIS", temp);
               ...
               // rpParameter.Add(new ReportParameter("trans_type", trans_type));
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("PaymentActivityReport.rdlc");
            ...
            {
                Response.Redirect("PaymentActivityReport.aspx?IsRecord=" + "0" + "&msg=" + "No Record Found");
            }
        }
        catch (Exception ex)
        {
    ...
    public string GetReportName()
    {
        ...
        parm[0] = RptObj.OracleDBParameter("v_Report_Code", "R9", "String", "In");
