...
public partial class NRTransDetailRpt : System.Web.UI.Page
{
    ...
    private void Generate(string date, string CompanyCode)
    {
        ...
        try
        {
            ...
            if (temp.Rows.Count > 0)
            {
                ...
                ("MCB_DataSet_NRTransDetail", temp);
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("NRTransDetailReport.rdlc");
            ...
            {
                Response.Redirect("NRTransDetailReport.aspx?IsRecord=" + "0" + "&msg=" + "No Record Found");
            }
        }
        catch (Exception ex)
        {
