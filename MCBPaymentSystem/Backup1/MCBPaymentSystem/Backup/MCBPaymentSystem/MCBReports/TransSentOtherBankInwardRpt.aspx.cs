...
public partial class TransSentOtherBankInwardRpt : System.Web.UI.Page
{
    ...
    private void Generate(string date)
    {
        ...
        try
        {
            ...
            if (temp.Rows.Count > 0)
            {
                ...
                ("MCB_DataSet_IntraBankTransa", temp);
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("TransSentOtherBankInwardReport.rdlc");
            ...
            {
                Response.Redirect("TransSentOtherBankInwardReport.aspx?IsRecord=" + "0" + "&msg=" + "No Record Found");
            }
        }
        catch (Exception ex)
        {
    ...
    private DataTable GetData(string date)
    {
        ...
        dsReport = RptObj.Oracle_GetDataSetSP("sp_intra_bank_trans_report", parm);
