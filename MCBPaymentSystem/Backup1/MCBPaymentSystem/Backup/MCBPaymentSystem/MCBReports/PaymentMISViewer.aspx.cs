...
public partial class PaymentMISViewer : System.Web.UI.Page
{
    ...
    private void Generate(string companyCode, string status, string fromDate, string toDate, string trans_type, string selecttype,string CompanyType)
    {
        ...
        try
        {
            ...
            {
                Response.Redirect("PaymentMIS.aspx?IsRecord=" + "0" + "&msg=" + "Session expired, please re-login.");
            }
            ...
            if (temp.Rows.Count > 0)
            {
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("PaymenrMISReport.rdlc");
            ...
            else
            {
                ...
                //Response.Redirect("PaymentMIS.aspx?IsRecord=" + "0" + "&msg=" + "No Record Found");
            }
        }
        catch (Exception ex)
        {
    ...
    public string GetReportName()
    {
        ...
        parm[0] = RptObj.OracleDBParameter("v_Report_Code", "R3", "String", "In");
