...
public partial class IntraBankTransactionRpt : System.Web.UI.Page
{
    ...
    private void Generate(string date)
    {
        ...
        try
        {
            ...
            if (temp.Rows.Count > 0)
            {
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("IntraBankTransactionReport.rdlc");
            ...
            {
                Response.Redirect("IntraBankTransactionReport.aspx?IsRecord=" + "0" + "&msg=" + "No Record Found");
            }
        }
        catch (Exception ex)
        {
