...
public partial class DraftTransactionRpt : System.Web.UI.Page
{
    ...
    private void Generate(string CompanyCode, string fileName, string Authorize1, string Authorize2, string IBC1, string IBC2)
    {
        ...
        try
        {
            ...
            if (temp.Rows.Count > 0)
            {
                ...
                this.ReportViewer1.LocalReport.ReportPath = Server.MapPath("DraftTransactionRpt2.rdlc");
            ...
            {
                Response.Redirect("DraftTransactionReport.aspx?errorMsg=" +"No record found.");
            }
        }
        catch (Exception ex)
        {
