<%@ Page Language="C#" MasterPageFile="~/MasterPage/RoutinePage.master" AutoEventWireup="true"
    CodeFile="PaymentMIS.aspx.cs" Inherits="PaymentMIS" Title="Untitled Page" %>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <asp:Label ID="lbl_Heading" runat="server" CssClass="lblHeading" Font-Size="Large"
                                SkinID="FormViewHeading" Width="100%" Text="Paid Report"></asp:Label>
                                ...
                                <tbody>
                                    ...
                                    <tr align="right">
                                        <td style="font-weight: bold; color: red; height: 26px; text-align: center" class="TableColumns"
                                            colspan="5">
                                            <asp:Button ID="btn_OK" OnClick="btn_OK_Click" runat="server" Width="78px" Text="Fetch"
