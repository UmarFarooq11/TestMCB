...
public partial class DraftTransactionRptBL : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Generate(CompanyCode, fileName, Authorize1, Authorize2, IBC1, IBC2);
    }
    private void Generate(string CompanyCode, string fileName, string Authorize1, string Authorize2, string IBC1, string IBC2)
    {
        ...
        try
        {
            ...
            if (temp.Rows.Count > 0)
            {
                ...
                this.ReportViewer1.LocalReport.ReportPath = Server.MapPath("DraftTransactionReportBL.rdlc");
            ...
            {
                Response.Redirect("DraftTransactionReportBL.aspx?errorMsg=" + "No record found.");
            }
        }
        catch (Exception ex)
        {
    ...
    private DataTable GetReportData(string[] whereFilter)
    {
        ...
        DataSet dsReport = RptObj.Oracle_GetDataSetSP("SP_DRAFTTRANSACTION_RPT_BL", spParams);
