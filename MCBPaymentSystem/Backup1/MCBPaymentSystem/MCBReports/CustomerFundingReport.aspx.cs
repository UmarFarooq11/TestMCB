...
public partial class CustomerFundingReport : System.Web.UI.Page
{
    ...
    protected void btn_OK_Click(object sender, EventArgs e)
    {
        ...
        //string trans_type = (DDL_TransType.SelectedValue.ToString() == "NULL") ? "" : DDL_TransType.SelectedValue.ToString();
            ...
            Response.Redirect("CustomerFundingRpt.aspx?companycode=" + companycode + "&fromdate=" + fromDate + "&todate=" + toDate + "&COMPANYNAME=" + companyname + "&balance=" + balance);
