...
public partial class AuthorizationMatrix_frmSPDS_AuthorizationMatrix : System.Web.UI.Page
{
    string[] ARY;
    string RGS_SUPPORT;
    ...
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            Session["SPDS_AuthorizationMatrix_ID"] = GridView1.DataKeys[this.GridView1.SelectedIndex].Value.ToString();
            Session["SPDS_AuthorizationMatrix_CUSTOMER_NAME"] = GridView1.SelectedRow.Cells[1].Text;
            Session["SPDS_AuthorizationMatrix_INSTRUMENT_NAME"] = GridView1.SelectedRow.Cells[2].Text;
            Session["SPDS_AuthorizationMatrix_MAKE_SIGNATORY_NAME"] = GridView1.SelectedRow.Cells[3].Text;
            Session["SPDS_AuthorizationMatrix_CHECKER_SIGNATORY_NAME"] = GridView1.SelectedRow.Cells[4].Text;
            Session["SPDS_AuthorizationMatrix_CATEGORYNAME"] = GridView1.SelectedRow.Cells[5].Text;
    ...
    {
        if (RD_CUSTOMER_ID.Checked == true)
        {
            Session["SPDS_AuthorizationMatrix_CUSTOMER_NAME"] = AlphaSelection1.AlphaClick + '%';
            Session["SPDS_AuthorizationMatrix_INSTRUMENT_NAME"] = '%';
            Session["SPDS_AuthorizationMatrix_MAKE_SIGNATORY_NAME"] = '%';
            Session["SPDS_AuthorizationMatrix_CHECKER_SIGNATORY_NAME"] = '%';
            Session["SPDS_AuthorizationMatrix_CATEGORY_NAME"] = '%';
        }
        if (RD_INSTRUMENT_ID.Checked == true)
        {
            Session["SPDS_AuthorizationMatrix_CUSTOMER_NAME"] = '%';
            Session["SPDS_AuthorizationMatrix_INSTRUMENT_NAME"] = AlphaSelection1.AlphaClick + '%';
            Session["SPDS_AuthorizationMatrix_MAKE_SIGNATORY_NAME"] = '%';
            Session["SPDS_AuthorizationMatrix_CHECKER_SIGNATORY_NAME"] = '%';
            Session["SPDS_AuthorizationMatrix_CATEGORY_NAME"] = '%';
        }
        if (RD_MAKE_SIGNATORY_ID.Checked == true)
        {
            Session["SPDS_AuthorizationMatrix_CUSTOMER_NAME"] = '%';
            Session["SPDS_AuthorizationMatrix_INSTRUMENT_NAME"] = '%';
            Session["SPDS_AuthorizationMatrix_MAKE_SIGNATORY_NAME"] = AlphaSelection1.AlphaClick + '%';
            Session["SPDS_AuthorizationMatrix_CHECKER_SIGNATORY_NAME"] = '%';
            Session["SPDS_AuthorizationMatrix_CATEGORY_NAME"] = '%';
        }
        if (RD_CHECKER_SIGNATORY_ID.Checked == true)
        {
            Session["SPDS_AuthorizationMatrix_CUSTOMER_NAME"] = '%';
            Session["SPDS_AuthorizationMatrix_INSTRUMENT_NAME"] = '%';
            Session["SPDS_AuthorizationMatrix_MAKE_SIGNATORY_NAME"] = '%';
            Session["SPDS_AuthorizationMatrix_CHECKER_SIGNATORY_NAME"] = AlphaSelection1.AlphaClick + '%';
            Session["SPDS_AuthorizationMatrix_CATEGORY_NAME"] = '%';
        }
        if (RD_CATEGORY_ID.Checked == true)
        {
            Session["SPDS_AuthorizationMatrix_CUSTOMER_NAME"] = '%';
            Session["SPDS_AuthorizationMatrix_INSTRUMENT_NAME"] = '%';
            Session["SPDS_AuthorizationMatrix_MAKE_SIGNATORY_NAME"] = '%';
            Session["SPDS_AuthorizationMatrix_CHECKER_SIGNATORY_NAME"] = '%';
           // Session["SPDS_AuthorizationMatrix_CATEGORY_ID"] = AlphaSelection1.AlphaClick + '%';
            Session["SPDS_AuthorizationMatrix_CATEGORY_NAME"] = AlphaSelection1.AlphaClick + '%';
        }
    }
