...
public partial class CustomerSetup_LOV_Customer : System.Web.UI.Page
{
    ...
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Session["Source"] = GridView1.DataKeys[this.GridView1.SelectedIndex].Value.ToString();
        Session["ConfigurationName"] = GridView1.SelectedRow.Cells[1].Text;
    ...
    private void AlphaSelection1_CK(object sender, EventArgs e)
    {
        ...
        {
            Session["Source"] = '%';
            Session["ConfigurationName"] = AlphaSelection1.AlphaClick + '%';
        }
    }
