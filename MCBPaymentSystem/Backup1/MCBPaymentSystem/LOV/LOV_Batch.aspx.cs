...
public partial class LOV_Batch : System.Web.UI.Page
{
    ...
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Session["LOV_PrincipleBankId"] = GridView1.SelectedRow.Cells[1].Text;
        Session["LOV_HeaderId"] = GridView1.SelectedRow.Cells[2].Text;
        Session["LOV_BatchDate"] = GridView1.SelectedRow.Cells[3].Text;
        Session["LOV_BatchNumber"] = GridView1.SelectedRow.Cells[4].Text;
        Session["LOV_NumberOfTransactions"] = GridView1.SelectedRow.Cells[5].Text;
    }
    ...
    //    //{
    //    //    Session["CMN_PrincipleBankName"] = AlphaSelection1.AlphaClick + '%';
    //    //}   
    //}
    ...
    protected void ToolBar1_ItemClick(object sender, EO.Web.ToolBarEventArgs e)
    {
        ...
        {
            Session["CMN_PrincipleBankName"] = "%" + TXT_PrincipleBankID.Text + "%";
        }
