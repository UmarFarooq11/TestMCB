<%@ Page Language="C#" Theme="ColorSchemeBlue" AutoEventWireup="true" CodeFile="LOV_Comp_Name_Comm.aspx.cs"
    Inherits="LOV_Comp_Name_Comm" %>
                    ...
                    <tr>
                        <td class="GridBar" style="width: 98%">
                            ...
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                AutoGenerateColumns="False" Font-Names="Verdana" Font-Size="8pt" OnRowDataBound="GridView1_RowDataBound"
                                OnSelectedIndexChanged="GridView1_SelectedIndexChanged" PageSize="20" ShowFooter="True"
                                DataKeyNames="COMPANY_CODE" DataSourceID="sp_Company_name_LOV" Style="width: 100%"
                                Width="100%">
                            ...
                            <asp:ObjectDataSource ID="sp_Company_name_LOV" runat="server" OldValuesParameterFormatString="original_{0}"
                                SelectMethod="LOV_Company_Name_Comm" TypeName="LOV_COLLECTION"></asp:ObjectDataSource>
                            &nbsp;
                        </td>
                    </tr>
                </table>
