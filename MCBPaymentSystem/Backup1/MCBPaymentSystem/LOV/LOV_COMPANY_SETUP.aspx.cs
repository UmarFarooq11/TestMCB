...
public partial class LOV_LOV_COMPANY_SETUP : System.Web.UI.Page
{
 protected void Page_Load(object sender, EventArgs e)
 {
    ...
    {
        Session["COMPANY_CODE"] = GridView1.DataKeys[this.GridView1.SelectedIndex].Value.ToString();
        Session["COMPANY_NAME"] = GridView1.SelectedRow.Cells[1].Text;
        Session["GROUP_CODE"] = GridView1.SelectedRow.Cells[2].Text;

        Session["LOV_ID"] = GridView1.SelectedRow.Cells[0].Text;
        Session["LOV_DESCRIPTION"] = GridView1.SelectedRow.Cells[1].Text;

        TXT_COMPANY_CODE.Text = GridView1.DataKeys[this.GridView1.SelectedIndex].Value.ToString();
        TXT_COMPANY_NAME.Text = GridView1.SelectedRow.Cells[1].Text;
        //     TXT_GROUP_CODE.Text = GridView1.SelectedRow.Cells[2].Text;
    }
    ...
    private void AlphaSelection1_CK(object sender, EventArgs e)
    {
        ...
        if (RD_COMPANY_NAME.Checked == true)
        {
            ...
            Session["COMPANY_NAME"] = AlphaSelection1.AlphaClick + '%';
            Session["GROUP_CODE"] = '%';
        }
        //if (RD_GROUP_CODE.Checked == true)
        //{
        //    Session["COMPANY_CODE"] = '%';
        //    Session["COMPANY_NAME"] = '%';
        //    Session["GROUP_CODE"] = AlphaSelection1.AlphaClick + '%';
        //}        
    }
