...
public partial class CourierMasterSetup_frmCMN_Courier : System.Web.UI.Page
{
    ...
    {
        Session["CMN_Courier_CourierCode"] = GridView1.SelectedRow.Cells[1].Text;
        Session["CMN_Courier_CourierName"] = GridView1.SelectedRow.Cells[2].Text;
        //TXT_DESCRIPTION_LOV.Text = GridView1.SelectedRow.Cells[1].Text;
    ...
    private void AlphaSelection1_CK(object sender, EventArgs e)
    {
        ...
        if (RD_CourierName.Checked == true)
        {
            Session["CMN_Courier_CourierCode"] = '%';
            Session["CMN_Courier_CourierName"] = AlphaSelection1.AlphaClick + '%';
        }
    }
    ...
    protected void ToolBar1_ItemClick(object sender, EO.Web.ToolBarEventArgs e)
    {
        ...
        {
            Session["CMN_Courier_CourierCode"] = "%" + TXT_CourierCode.Text + "%";
            Session["CMN_Courier_CourierName"] = "%" + TXT_CourierName.Text + "%";
        }
        else if (e.Item.ToolTip == "Refresh")
        {
            TXT_CourierCode.Text = "";
