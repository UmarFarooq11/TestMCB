...
public partial class LOV_LOV_CITY_SETUP : System.Web.UI.Page
{
    ...
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Session["CITY_CODE"] = GridView1.SelectedRow.Cells[0].Text;
        Session["DESCRIPTION"] = GridView1.SelectedRow.Cells[1].Text;
        
        TXT_CITY_CODE.Text = GridView1.SelectedRow.Cells[0].Text;
        TXT_CITYNAME.Text = GridView1.SelectedRow.Cells[1].Text;
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        Session["CITY_CODE"] = "%" + TXT_CITY_CODE.Text + "%";
        Session["DESCRIPTION"] = "%" + TXT_CITYNAME.Text + "%";
    }
    ...
    private void AlphaSelection1_CK(object sender, EventArgs e)
    {
        ...
        LBL_GridStatus.Text = "Page(s): 0-0";
        LBL_RowStatus.Text = "Display Row(s): 0-0";
        if (RD_CITY_CODE.Checked == true)
        {
            Session["CITY_CODE"] = AlphaSelection1.AlphaClick + '%';
            Session["DESCRIPTION"] = '%';
        }

        if (RD_CITY_NAME.Checked == true)
        {
            Session["CITY_CODE"] = '%';
            Session["DESCRIPTION"] = AlphaSelection1.AlphaClick + '%';
        }
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        TXT_CITY_CODE.Text = "";
        TXT_CITYNAME.Text = "";
        RD_CITY_CODE.Checked = false;
        RD_CITY_NAME.Checked = false;
    }

    protected void LOV_SP_CITY_SETUP_ALL_Selected(object sender, ObjectDataSourceStatusEventArgs e)
    {
