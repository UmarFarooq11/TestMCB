<%@ Page Language="C#" MasterPageFile="~/MasterPage/RoutinePage.master" AutoEventWireup="true" CodeFile="LOV_RemittanceNO.aspx.cs" Inherits="LOV_Batch" Title = "Remittance No - LOV" %>
<%@ Register
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    &nbsp;<asp:Label ID="Label1" runat="server" Font-Names="Trebuchet MS" Font-Size="20pt"
        SkinID="Heading" Text="Remittance No" Width="100%"></asp:Label>
...
<asp:BoundField DataField="RemittanceRefNo" HeaderText="Remittance No" SortExpression="RemittanceRefNo"></asp:BoundField>
...
</asp:GridView> </TD></TR></TBODY></TABLE> <asp:ObjectDataSource id="SP_Remitter_ALL" runat="server" __designer:dtid="3940649673949190" TypeName="LOV_COLLECTION" SelectMethod="GET_RPS_SP_Remittance_LOV" OldValuesParameterFormatString="original_{0}" __designer:wfdid="w1">
        <SelectParameters __designer:dtid="3940649673949191">
            <asp:SessionParameter __designer:dtid="3940649673949192" DefaultValue="%" Name="RemittanceCode" SessionField="rps_sp_RemittanceCode"
                Type="String"  />
        </SelectParameters>
