<%@ Page Language="C#" MasterPageFile="~/MasterPage/RoutinePage.master" AutoEventWireup="true" CodeFile="LOV_Product.aspx.cs" Inherits="ProductMasterSetup_frmSPDS_ProductMaster" Title = "Product Master Setup - LOV" %>
<%@ Register
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <asp:Label ID="Label1" runat="server" Font-Names="Trebuchet MS" Font-Size="20pt"
        SkinID="Heading" Text="Product Master Setup" Width="100%"></asp:Label>
...
<TABLE style="FONT-SIZE: 8pt; FONT-FAMILY: Verdana" width="100%"><TBODY><TR align=right><TD style="WIDTH: 25%; TEXT-ALIGN: right">Product Code :&nbsp;
</TD><TD style="WIDTH: 25%; TEXT-ALIGN: left">
    &nbsp;<asp:TextBox id="TXT_ProductCode" runat="server" Width="200px" SkinID="TXT"></asp:TextBox> <ajaxToolkit:FilteredTextBoxExtender id="FilteredTextBoxExtender1" runat="server" TargetControlID="TXT_ProductCode" FilterType="Numbers" Enabled="True"></ajaxToolkit:FilteredTextBoxExtender> </TD><TD style="WIDTH: 25%; TEXT-ALIGN: right">Product Name :&nbsp;</TD><TD style="WIDTH: 25%; TEXT-ALIGN: left">
    &nbsp;<asp:TextBox id="TXT_ProductName" runat="server" Width="200px" SkinID="TXT"></asp:TextBox> </TD></TR></TBODY></TABLE>
</ContentTemplate>
<HeaderTemplate>
Basic Search
</HeaderTemplate>
...
<TABLE style="FONT-SIZE: 8pt; FONT-FAMILY: Verdana" width="100%"><TBODY><TR><TD style="WIDTH: 25%; TEXT-ALIGN: center"><asp:RadioButton id="RD_ProductName" runat="server" Text="Product Name" GroupName="A"></asp:RadioButton> </TD></TR><TR></TR></TBODY></TABLE><uc1:AlphaSelection id="AlphaSelection1" runat="server"></uc1:AlphaSelection> 
</ContentTemplate>
<HeaderTemplate>
Alpha Search
</HeaderTemplate>
...
<asp:BoundField DataField="ProductCode" SortExpression="ProductCode" HeaderText="Product Code"></asp:BoundField>
<asp:BoundField DataField="ProductName" SortExpression="ProductName" HeaderText="Product Name"></asp:BoundField>
...
<HeaderStyle HorizontalAlign="Left"></HeaderStyle>
    ...
    <asp:ObjectDataSource ID="SP_SPDS_ProductMaster_ALL" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Get_SPDS_ProductMaster_LOV" TypeName="LOV_COLLECTION">
        <SelectParameters>
            <asp:SessionParameter DefaultValue="%" Name="ProductCode" SessionField="SPDS_ProductMaster_ProductCode"
                Type="String" />
            <asp:SessionParameter DefaultValue="%" Name="ProductName" SessionField="SPDS_ProductMaster_ProductName"
                Type="String" />
        </SelectParameters>
