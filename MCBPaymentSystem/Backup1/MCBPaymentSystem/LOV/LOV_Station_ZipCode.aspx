<%@ Page Language="C#" MasterPageFile="~/MasterPage/RoutinePage.master" AutoEventWireup="true" CodeFile="LOV_Station_ZipCode.aspx.cs" Inherits="MasterZipCodeSetup_frmRPS_MasterZipCode" Title = "Master ZipCode Setup - LOV" %>
<%@ Register
...
<PagerStyle BorderStyle="Solid" BorderColor="#404040"></PagerStyle>
    ...
    <asp:ObjectDataSource ID="SP_RPS_MasterZipCode_LOV" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Get_SP_RPS_Station_ZipCodeLOV" TypeName="LOV_COLLECTION">
        <SelectParameters>
            ...
            <asp:SessionParameter DefaultValue="%" Name="STATIONNAME" SessionField="RPS_MasterZipCode_StationID"
                Type="String" />
            <asp:SessionParameter DefaultValue="0" Name="StaionID" SessionField="StationID" Type="String" />
        </SelectParameters>
