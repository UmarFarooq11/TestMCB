<%@ Page Language="C#" MasterPageFile="~/MasterPage/RoutinePage.master" AutoEventWireup="true" CodeFile="Copy of LOV_Draft.aspx.cs" Inherits="Draft_frmRPS_Draft" Title = "Draft No - LOV" %>
<%@ Register
...
Text="Draft No" Width="100%" SkinID="Heading"></asp:Label><asp:UpdatePanel id="UpdatePanel1" runat="server">
<contenttemplate>
...
<td style="width: 25%; text-align: left">
    &nbsp;<asp:TextBox ID="TXT_DraftNo" runat="server" Width="200px" SkinID="TXT"></asp:TextBox>
</td>
</tr>
</table>
</ContentTemplate>
...
<asp:BoundField DataField="IncomingBatchHeader" HeaderText="Incoming Batch Header" SortExpression="IncomingBatchHeader"></asp:BoundField>
...
<HeaderStyle HorizontalAlign="Left"></HeaderStyle>
    ...
    <asp:ObjectDataSource ID="SP_RPS_Draft_ALL" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Get_RPS_Draft_ALL" TypeName="LOV_COLLECTION">
        <SelectParameters>
