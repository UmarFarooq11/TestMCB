<%@ Page Language="C#" MasterPageFile="~/MasterPage/RoutinePage.master" AutoEventWireup="true" CodeFile="LOV_MasterZipCode.aspx.cs" Inherits="MasterZipCodeSetup_frmRPS_MasterZipCode" Title = "Master ZipCode Setup - LOV" %>
<%@ Register
...
<TABLE style="FONT-SIZE: 8pt; FONT-FAMILY: Verdana" width="100%"><TBODY>
    ...
    <TR align=right><TD style="WIDTH: 25%; TEXT-ALIGN: right">Zip Code :&nbsp;
</TD><TD style="WIDTH: 25%; TEXT-ALIGN: left">&nbsp;<asp:TextBox id="TXT_ZipCode" runat="server" Width="200px" SkinID="TXT"></asp:TextBox> </TD><TD style="WIDTH: 25%; TEXT-ALIGN: right"></TD><TD style="WIDTH: 25%; TEXT-ALIGN: left">&nbsp;</TD></TR></TBODY></TABLE>
</ContentTemplate>
<HeaderTemplate>
Basic Search
</HeaderTemplate>
...
<HeaderStyle HorizontalAlign="Left"></HeaderStyle>
    ...
    <asp:BoundField DataField="Courier" HeaderText="Courier Name" SortExpression="Courier" />
    <asp:BoundField DataField="Station" HeaderText="Station Name" SortExpression="Station" />
    ...
    <asp:BoundField DataField="E_DateTime" HeaderText="Creation Date" SortExpression="E_DateTime" />
...
<PagerStyle BorderStyle="Solid" BorderColor="#404040"></PagerStyle>
    ...
    <asp:ObjectDataSource ID="SP_RPS_MasterZipCode_ALL" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Get_RPS_MasterZipCodeLOVSendBranch_ALL" TypeName="LOV_COLLECTION">
        <SelectParameters>
