<%@ Page Language="C#" MasterPageFile="~/MasterPage/RoutinePage.master" AutoEventWireup="true" CodeFile="LOV_Customer.aspx.cs" Inherits="CustomerSetup_LOV_Customer" Title = "Customer Setup - LOV" %>
...
<ContentTemplate>
<TABLE style="FONT-SIZE: 8pt; FONT-FAMILY: Verdana" width="100%"><TBODY><TR align=right><TD style="WIDTH: 25%; TEXT-ALIGN: right">Customer Code :</TD><TD style="WIDTH: 25%; TEXT-ALIGN: left">&nbsp;<asp:TextBox id="TXT_BankCode" runat="server" Width="200px" SkinID="TXT" MaxLength="1"></asp:TextBox> <ajaxToolkit:FilteredTextBoxExtender id="FilteredTextBoxExtender1" runat="server" TargetControlID="TXT_BankCode" Enabled="True" FilterType="Numbers"></ajaxToolkit:FilteredTextBoxExtender> </TD><TD style="WIDTH: 25%; TEXT-ALIGN: right">Customer Name :</TD><TD style="WIDTH: 25%; TEXT-ALIGN: left">&nbsp;<asp:TextBox id="TXT_BankName" runat="server" Width="200px" SkinID="TXT"></asp:TextBox> </TD></TR></TBODY></TABLE>
</ContentTemplate>
...
<Columns>
<asp:BoundField DataField="BankCode" HeaderText="ID" SortExpression="BankCode" Visible="False"></asp:BoundField>
<asp:BoundField DataField="BankCode" HeaderText="Customer Code" SortExpression="BankCode"></asp:BoundField>
<asp:BoundField DataField="BankName" HeaderText="Customer Name" SortExpression="BankName"></asp:BoundField>
<asp:BoundField DataField="Abbreviation" HeaderText="Abbreviation" SortExpression="Abbreviation"></asp:BoundField>
...
<HeaderStyle HorizontalAlign="Left"></HeaderStyle>
    ...
    <asp:ObjectDataSource ID="SP_RPS_Bank_ALL" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Get_RPS_CustomerSetup_LOV" TypeName="LOV_COLLECTION">
        <SelectParameters>
