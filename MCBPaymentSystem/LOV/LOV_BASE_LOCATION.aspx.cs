...
public partial class LOV_LOV_BASE_LOCATION : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        //Session["BASE_LOCATION_CODE"] = "%" + TXT_BASE_LOCATION_CODE.Text + "%";
        //Session["DESCRIPTION"] = "%" + TXT_DESCRIPTION_LOV.Text + "%";
        Session["FILE_NAME"] = "%" + TXT_BASE_LOCATION_CODE.Text + "%";
    }
    private void AlphaSelection1_CK(object sender, EventArgs e)
    {
        ...
        LBL_GridStatus.Text = "Page(s): 0-0";
        LBL_RowStatus.Text = "Display Row(s): 0-0";
        if (RD_BASE_LOCATION_CODE.Checked == true)
        {
            Session["DESCRIPTION"] = '%';
            Session["BASE_LOCATION_CODE"] = AlphaSelection1.AlphaClick + '%';
        }
        if (RD_DESCRIPTION.Checked == true)
        {
            Session["BASE_LOCATION_CODE"] = '%';
    ...
    {
        TXT_BASE_LOCATION_CODE.Text = "";
        TXT_DESCRIPTION_LOV.Text = "";
    }
  
    protected void SP_BASE_LOCATION_ALL_Selected(object sender, ObjectDataSourceStatusEventArgs e)
    {
    ...
    protected void RD_DESCRIPTION_CheckedChanged(object sender, EventArgs e)
    {

    }
    protected void AlphaSelection1_Load(object sender, EventArgs e)
    {
