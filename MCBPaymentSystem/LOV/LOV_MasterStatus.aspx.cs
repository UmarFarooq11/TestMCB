...
public partial class MasterCodeSetup_frmRPS_MasterStatus : System.Web.UI.Page
{
    ...
    private void AlphaSelection1_CK(object sender, EventArgs e)
    {
        ...
        {
            Session["RPS_MasterStatus_MasterStatusCode"] = '%';
            Session["RPS_MasterStatus_Description"] = AlphaSelection1.AlphaClick + '%';
        }
    }
    ...
    protected void ToolBar1_ItemClick(object sender, EO.Web.ToolBarEventArgs e)
    {
        ...
        {
            Session["RPS_MasterStatus_MasterStatusCode"] = "%" + TXT_MasterStatusCode.Text + "%";
            Session["RPS_MasterStatus_Description"] = "%" + TXT_Description.Text + "%";
        }
        else if (e.Item.ToolTip == "Refresh")
        {
            TXT_MasterStatusCode.Text = "";
