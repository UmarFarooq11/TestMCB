<%@ Page Language="C#" MasterPageFile="~/MasterPage/RoutinePage.master" AutoEventWireup="true" CodeFile="LOV_DraftRelease.aspx.cs" Inherits="LOV_LOV_DraftRelease" Title = "Draft Released - LOV" %>
<%@ Register
...
Text="Draft Released" Width="100%" SkinID="Heading"></asp:Label>
...
<TABLE style="FONT-SIZE: 8pt; FONT-FAMILY: Verdana" width="100%"><TBODY><TR align=right><TD style="WIDTH: 25%; TEXT-ALIGN: right">Draft No :&nbsp;
</TD><TD style="WIDTH: 25%; TEXT-ALIGN: left">
    &nbsp;<asp:TextBox id="TXT_DraftNo" runat="server" Width="200px" SkinID="TXT"></asp:TextBox> </TD><TD style="WIDTH: 25%; TEXT-ALIGN: right">Remittance Ref No :&nbsp;
</TD><TD style="WIDTH: 25%; TEXT-ALIGN: left">
    &nbsp;<asp:TextBox id="TXT_RemittanceRefNo" runat="server" Width="200px" SkinID="TXT"></asp:TextBox> </TD></TR>
    <tr align="right">
        <td style="width: 25%; text-align: right">
            Remitter No :&nbsp;
        </td>
        <td style="width: 25%; text-align: left">
    &nbsp;<asp:TextBox id="TXT_RemitterNo" runat="server" Width="200px" SkinID="TXT"></asp:TextBox></td>
        <td style="width: 25%; text-align: right">
            Remitter Name :&nbsp;
        </td>
        <td style="width: 25%; text-align: left">
    &nbsp;<asp:TextBox id="TXT_RemitterName" runat="server" Width="200px" SkinID="TXT"></asp:TextBox></td>
    </tr>
    <TR align=right><TD style="WIDTH: 25%; TEXT-ALIGN: right">Beneficiary No :&nbsp;
</TD><TD style="WIDTH: 25%; TEXT-ALIGN: left">
    &nbsp;<asp:TextBox id="TXT_BeneficiaryNo" runat="server" Width="200px" SkinID="TXT"></asp:TextBox> </TD><TD style="WIDTH: 25%; TEXT-ALIGN: right">
        Beneficiary Name :&nbsp;
    </TD><TD style="WIDTH: 25%; TEXT-ALIGN: left">
        &nbsp;<asp:TextBox ID="TXT_BeneficiaryName" runat="server" SkinID="TXT" Width="200px"></asp:TextBox></TD></TR></TBODY></TABLE> 
</ContentTemplate>
<HeaderTemplate>
Basic Search
</HeaderTemplate>
...
<table style="font-size: 8pt; font-family: Verdana" width="100%">
                        <tr>
                            ...
                            <td style="width: 25%; text-align: center">
                                <asp:RadioButton ID="RD_BeneficiaryNo" runat="server" GroupName="A" Text="Beneficiary No"  /></td>
                            <td style="width: 25%; text-align: center">
                                <asp:RadioButton ID="RD_RemittanceRefNo" runat="server" GroupName="A" Text="Remittance Ref No"  /></td>
                        </tr>
                        <tr>
                            <td style="width: 25%; text-align: center">
                                <asp:RadioButton ID="RD_RemitterNo" runat="server" GroupName="A" Text="Remitter No"  /></td>
                            <td style="width: 25%; text-align: center">
                                <asp:RadioButton ID="RD_BeneficiaryNo1" runat="server" GroupName="A" Text="Beneficiary No"  /></td>
                        </tr>
                        <tr>
                        </tr>
                   </table>
...
<asp:BoundField DataField="DraftNo" SortExpression="DraftNo" HeaderText="Draft No"></asp:BoundField>
<asp:BoundField DataField="RemitterNo" SortExpression="RemitterNo" HeaderText="Remitter No"></asp:BoundField>
<asp:BoundField DataField="RemitterName" SortExpression="RemitterName" HeaderText="Remitter Name"></asp:BoundField>
<asp:BoundField DataField="RemittanceRefNo" SortExpression="RemittanceRefNo" HeaderText="Remittance Ref No"></asp:BoundField>
<asp:BoundField DataField="BeneficiaryNo" SortExpression="BeneficiaryNo" HeaderText="Beneficiary No"></asp:BoundField>
<asp:BoundField DataField="BeneficiaryName" SortExpression="BeneficiaryName" HeaderText="Beneficiary Name"></asp:BoundField>
...
<PagerStyle BorderStyle="Solid" BorderColor="#404040"></PagerStyle>
    ...
    <asp:ObjectDataSource ID="SP_GetDraftReleased_ALL" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Get_GetDraftReleased_ALL" TypeName="LOV_COLLECTION">
        <SelectParameters>
            <asp:SessionParameter DefaultValue="0" Name="DraftNo" SessionField="GetDraftReleased_DraftNo"
                Type="String" />
            <asp:SessionParameter DefaultValue="0" Name="BeneficiaryName" SessionField="GetDraftReleased_BeneficiaryName"
                Type="String" />
            <asp:SessionParameter DefaultValue="0" Name="RemitterName" SessionField="GetDraftReleased_RemitterName"
                Type="String" />
            <asp:SessionParameter DefaultValue="0" Name="RemittanceRefNo" SessionField="GetDraftReleased_RemittanceRefNo"
                Type="String" />
            <asp:SessionParameter DefaultValue="0" Name="BeneficiaryNo" SessionField="GetDraftReleased_BeneficiaryNo"
                Type="String" />
            <asp:SessionParameter DefaultValue="0" Name="RemitterNo" SessionField="GetDraftReleased_RemitterNo"
                Type="String" />
        </SelectParameters>
