...
public partial class LOV_DataLoadConfigurationDetail : System.Web.UI.Page
{
    ...
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Session["LOV_Column_Order"] = GridView1.SelectedRow.Cells[0].Text;
        Session["LOV_Column_Name"] = GridView1.SelectedRow.Cells[1].Text;
    ...
    private void AlphaSelection1_CK(object sender, EventArgs e)
    {
        ...
        {
            Session["SPDS_LOV_CONFIF_DESC_DETAIL"] = AlphaSelection1.AlphaClick + '%';
            Session["SPDS_LOV_CONF_ID_DETAIL"] = "%";
        }
    }
    ...
    protected void ToolBar1_ItemClick(object sender, EO.Web.ToolBarEventArgs e)
    {
        ...
        {
            Session["SPDS_LOV_CONF_ID_DETAIL"] = "%" + TXT_DraftNo.Text + "%";
            Session["SPDS_LOV_CONFIF_DESC_DETAIL"] = "%";
        }
