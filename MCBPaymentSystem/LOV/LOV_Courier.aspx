<%@ Page Language="C#" MasterPageFile="~/MasterPage/RoutinePage.master" AutoEventWireup="true" CodeFile="LOV_Courier.aspx.cs" Inherits="CourierMasterSetup_frmCMN_Courier" Title = "Courier Master Setup - LOV" %>
<%@ Register
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <asp:Label ID="Label1" runat="server" Font-Names="Trebuchet MS" Font-Size="20pt"
        SkinID="Heading" Text="Courier Master Setup" Width="100%"></asp:Label>
...
<TABLE style="FONT-SIZE: 8pt; FONT-FAMILY: Verdana" width="100%"><TBODY><TR align=right><TD style="WIDTH: 25%; TEXT-ALIGN: right">Courier Code :&nbsp; </TD><TD style="WIDTH: 25%; TEXT-ALIGN: left">&nbsp;<asp:TextBox id="TXT_CourierCode" runat="server" Width="200px" MaxLength="1" SkinID="TXT"></asp:TextBox> <ajaxToolkit:FilteredTextBoxExtender id="fte_CourierCode" runat="server" Enabled="True" TargetControlID="TXT_CourierCode" FilterType="Numbers"></ajaxToolkit:FilteredTextBoxExtender> </TD><TD style="WIDTH: 25%; TEXT-ALIGN: right">Courier Name :&nbsp; </TD><TD style="WIDTH: 25%; TEXT-ALIGN: left">&nbsp;<asp:TextBox id="TXT_CourierName" runat="server" Width="200px" MaxLength="50" SkinID="TXT"></asp:TextBox> </TD></TR></TBODY></TABLE>
</ContentTemplate>
<HeaderTemplate>
Basic Search
</HeaderTemplate>
...
<table style="font-size: 8pt; font-family: Verdana" width="100%">
                        <tr>
                            <td style="width: 25%; text-align: center">
                                <asp:RadioButton ID="RD_CourierName" runat="server" GroupName="A" Text="Courier Name" /></td>
                        </tr>
                        <tr>
                        </tr>
                   </table>
...
<asp:BoundField DataField="CourierCode" SortExpression="CourierCode" HeaderText="Courier Code"></asp:BoundField>
<asp:BoundField DataField="CourierName" SortExpression="CourierName" HeaderText="Courier Name"></asp:BoundField>
...
<HeaderStyle HorizontalAlign="Left"></HeaderStyle>
    ...
    <asp:ObjectDataSource ID="SP_CMN_Courier_ALL" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Get_CMN_Courier_LOV" TypeName="LOV_COLLECTION">
        <SelectParameters>
            <asp:SessionParameter DefaultValue="%" Name="CourierCode" SessionField="CMN_Courier_CourierCode"
                Type="String" />
            <asp:SessionParameter DefaultValue="%" Name="CourierName" SessionField="CMN_Courier_CourierName"
                Type="String" />
        </SelectParameters>
