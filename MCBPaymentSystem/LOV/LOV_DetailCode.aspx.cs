...
public partial class DetailCodeSetup_frmRPS_DetailStatus : System.Web.UI.Page
{
    ...
    {
            Session["RPS_DetailStatus_ID"] = GridView1.DataKeys[this.GridView1.SelectedIndex].Value.ToString();
            Session["RPS_DetailStatus_StatusCode"] = GridView1.SelectedRow.Cells[1].Text;
            Session["RPS_DetailStatus_Description"] = GridView1.SelectedRow.Cells[2].Text;
    ...
    private void AlphaSelection1_CK(object sender, EventArgs e)
    {
        ...
        {
            Session["RPS_DetailStatus_StatusCode"] = '%';
            Session["RPS_DetailStatus_Description"] = AlphaSelection1.AlphaClick + '%';
        }
    }
    ...
    protected void ToolBar1_ItemClick(object sender, EO.Web.ToolBarEventArgs e)
    {
        ...
        {
            Session["RPS_DetailStatus_StatusCode"] = "%" + TXT_StatusCode.Text + "%";
            Session["RPS_DetailStatus_Description"] = "%" + TXT_Description.Text + "%";
        }
