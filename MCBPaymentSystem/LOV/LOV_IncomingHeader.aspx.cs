...
public partial class LOV_Batch : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (IsPostBack == false)
        {
           // Session["CMN_PrincipleBankName"] = "%";
            ...
            Session["LOV_ID"] = "";
            Session["LOV_TransationCode"] = "";
            Session["LOV_FileName"] = "";
            Session["LOV_CreationDateTime"] = "";
    ...
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Session["LOV_TransationCode"] = GridView1.SelectedRow.Cells[1].Text;
        Session["LOV_FileName"] = GridView1.SelectedRow.Cells[2].Text;
        Session["LOV_SenderCode"] = GridView1.SelectedRow.Cells[3].Text;
        Session["LOV_CreationDateTime"] = GridView1.SelectedRow.Cells[4].Text;
    }
    private void AlphaSelection1_CK(object sender, EventArgs e)
    {
        ...
        //{
        //    Session["FileName"] = AlphaSelection1.AlphaClick + '%';
        //}   
    }
    ...
    protected void ToolBar1_ItemClick(object sender, EO.Web.ToolBarEventArgs e)
    {
        ...
        {
            Session["FileName"] = "%" + TXT_PrincipleBankID.Text + "%";
        }
