...
public partial class MasterBeneficiaryInfo_LOV_Beneficiary : System.Web.UI.Page
{
    string[] ARY;
    string RGS_SUPPORT;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (IsPostBack == false)
        {
            Session["RPS_Beneficiary_ID"] = "";
            Session["RPS_Beneficiary_RemitterID"] = "";
            Session["RPS_Beneficiary_BeneficiaryNo"] = "";
            Session["RPS_Beneficiary_FirstName"] = "";
    ...
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            Session["RPS_Beneficiary_ID"] = GridView1.DataKeys[this.GridView1.SelectedIndex].Value.ToString();
            Session["RPS_Beneficiary_RemitterID"] = GridView1.SelectedRow.Cells[1].Text;
            Session["RPS_Beneficiary_BeneficiaryNo"] = GridView1.SelectedRow.Cells[2].Text;
            Session["RPS_Beneficiary_FirstName"] = GridView1.SelectedRow.Cells[5].Text;
            Session["LOV_ID"] = GridView1.DataKeys[this.GridView1.SelectedIndex].Value.ToString();
            Session["LOV_CODE"] = GridView1.SelectedRow.Cells[2].Text;
    ...
    private void AlphaSelection1_CK(object sender, EventArgs e)
    {
        ...
        ////if (RD_RemitterID.Checked == true)
        ////{
        ////    Session["RPS_Beneficiary_RemitterNo"] = AlphaSelection1.AlphaClick + '%';
        ////    Session["RPS_Beneficiary_BeneficiaryNo"] = '%';
        ////    Session["RPS_Beneficiary_CorrespondingBankName"] = '%';
        ////    Session["RPS_Beneficiary_BranchName"] = '%';
        ////    Session["RPS_Beneficiary_FirstName"] = '%';
        ////    Session["RPS_Beneficiary_MiddleName"] = '%';
        ////}
        ////if (RD_BeneficiaryNo.Checked == true)
        ////{
        ////    Session["RPS_Beneficiary_RemitterNo"] = '%';
        ////    Session["RPS_Beneficiary_BeneficiaryNo"] = AlphaSelection1.AlphaClick + '%';
        ////    Session["RPS_Beneficiary_CorrespondingBankName"] = '%';
        ////    Session["RPS_Beneficiary_BranchName"] = '%';
        ////    Session["RPS_Beneficiary_FirstName"] = '%';
        ////    Session["RPS_Beneficiary_MiddleName"] = '%';
        ...
        ////    Session["RPS_Beneficiary_RemitterNo"] = '%';
        ////    Session["RPS_Beneficiary_BeneficiaryNo"] = '%';
        ////    Session["RPS_Beneficiary_CorrespondingBankName"] = AlphaSelection1.AlphaClick + '%';
        ////    Session["RPS_Beneficiary_BranchName"] = '%';
        ////    Session["RPS_Beneficiary_FirstName"] = '%';
        ////    Session["RPS_Beneficiary_MiddleName"] = '%';
        ////}
        ...
        ////{
        ////    Session["RPS_Beneficiary_RemitterName"] = '%';
        ////    Session["RPS_Beneficiary_BeneficiaryNo"] = '%';
        ////    Session["RPS_Beneficiary_CorrespondingBankName"] = '%';
        ////    Session["RPS_Beneficiary_BranchName"] = AlphaSelection1.AlphaClick + '%';
        ////    Session["RPS_Beneficiary_FirstName"] = '%';
        ////    Session["RPS_Beneficiary_MiddleName"] = '%';
        ////}
        if (RD_FirstName.Checked == true)
        {
            ...
            Session["RPS_Beneficiary_CorrespondingBankName"] = '%';
            Session["RPS_Beneficiary_BranchName"] = '%';
            Session["RPS_Beneficiary_FirstName"] = AlphaSelection1.AlphaClick + '%';
            Session["RPS_Beneficiary_MiddleName"] = '%';
        }
        if (RD_MiddleName.Checked == true)
        {
            ...
            Session["RPS_Beneficiary_BranchName"] = '%';
            Session["RPS_Beneficiary_FirstName"] = '%';
            Session["RPS_Beneficiary_MiddleName"] = AlphaSelection1.AlphaClick + '%';
        }
    }
    ...
    protected void ToolBar1_ItemClick(object sender, EO.Web.ToolBarEventArgs e)
    {
        ...
        {
            Session["RPS_Beneficiary_RemitterNo"] = "%" + TXT_RemitterID.Text + "%";
            Session["RPS_Beneficiary_BeneficiaryNo"] = "%" + TXT_BeneficiaryNo.Text + "%";
            Session["RPS_Beneficiary_CorrespondingBankName"] = "%" + TXT_CorrespondingBankID.Text + "%";
            Session["RPS_Beneficiary_BranchName"] = "%" + TXT_BranchID.Text + "%";
            Session["RPS_Beneficiary_FirstName"] = "%" + TXT_FirstName.Text + "%";
            Session["RPS_Beneficiary_MiddleName"] = "%" + TXT_MiddleName.Text + "%";
        }
