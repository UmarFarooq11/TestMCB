<%@ Page Language="C#" MasterPageFile="~/MasterPage/RoutinePage.master" AutoEventWireup="true" CodeFile="LOV_MasterStatus.aspx.cs" Inherits="MasterCodeSetup_frmRPS_MasterStatus" Title = "Master Code Setup - LOV" %>
<%@ Register
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <asp:Label ID="Label1" runat="server" Font-Names="Trebuchet MS" Font-Size="20pt"
        SkinID="Heading" Text="Master Code Setup" Width="100%"></asp:Label>
...
<TABLE style="FONT-SIZE: 8pt; FONT-FAMILY: Verdana" width="100%"><TBODY><TR align=right><TD style="WIDTH: 25%; TEXT-ALIGN: right">Master Code :&nbsp;
</TD><TD style="WIDTH: 25%; TEXT-ALIGN: left">&nbsp;<asp:TextBox id="TXT_MasterStatusCode" runat="server" Width="200px" SkinID="TXT" MaxLength="4"></asp:TextBox> <ajaxToolkit:FilteredTextBoxExtender id="FilteredTextBoxExtender1" runat="server" TargetControlID="TXT_MasterStatusCode" FilterType="Numbers"></ajaxToolkit:FilteredTextBoxExtender> </TD><TD style="WIDTH: 25%; TEXT-ALIGN: right">Description :&nbsp;
</TD><TD style="WIDTH: 25%; TEXT-ALIGN: left">&nbsp;<asp:TextBox id="TXT_Description" runat="server" Width="200px" SkinID="TXT"></asp:TextBox> </TD></TR></TBODY></TABLE>
</ContentTemplate>
<HeaderTemplate>
Basic Search
</HeaderTemplate>
...
<TABLE style="FONT-SIZE: 8pt; FONT-FAMILY: Verdana" width="100%"><TBODY><TR><TD style="WIDTH: 25%; TEXT-ALIGN: center"><asp:RadioButton id="RD_Description" runat="server" Text="Description" GroupName="A"></asp:RadioButton> </TD></TR><TR></TR></TBODY></TABLE><uc1:AlphaSelection id="AlphaSelection1" runat="server"></uc1:AlphaSelection> 
</ContentTemplate>
<HeaderTemplate>
Alpha Search
</HeaderTemplate>
        ...
        <Columns>
            ...
            <asp:BoundField DataField="MasterStatusCode" HeaderText="Master Code" SortExpression="MasterStatusCode" />
    ...
    <asp:ObjectDataSource ID="SP_RPS_MasterStatus_ALL" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Get_RPS_MasterStatus_LOV" TypeName="LOV_COLLECTION">
        <SelectParameters>
            <asp:SessionParameter DefaultValue="%" Name="MasterStatusCode" SessionField="RPS_MasterStatus_MasterStatusCode"
                Type="String" />
            <asp:SessionParameter DefaultValue="%" Name="Description" SessionField="RPS_MasterStatus_Description"
                Type="String" />
        </SelectParameters>
