<%@ Page Language="C#" MasterPageFile="~/MasterPage/RoutinePage.master" AutoEventWireup="true"
    CodeFile="LOV_DataLoadConfigurationDetail.aspx.cs" Inherits="LOV_DataLoadConfigurationDetail"
    Title="Configuration Detail - LOV" %>
...
// ]]>
    ...
    <asp:Label ID="Label1" runat="server" Font-Names="Trebuchet MS" Font-Size="20pt"
        Text="Configuration ID Detail" Width="100%" SkinID="Heading"></asp:Label><asp:UpdatePanel
...
<ContentTemplate>
<TABLE style="FONT-SIZE: 8pt; FONT-FAMILY: Verdana" width="100%"><TBODY><TR align=right><TD style="WIDTH: 25%; TEXT-ALIGN: right">Column Order&nbsp;:&nbsp; </TD><TD style="WIDTH: 25%; TEXT-ALIGN: left">&nbsp;<asp:TextBox id="TXT_DraftNo" runat="server" SkinID="TXT" Width="200px" __designer:wfdid="w354"></asp:TextBox> </TD></TR></TBODY></TABLE>
</ContentTemplate>
...
<ContentTemplate>
<TABLE style="FONT-SIZE: 8pt; FONT-FAMILY: Verdana" width="100%"><TBODY><TR><TD style="WIDTH: 25%; TEXT-ALIGN: center"><asp:RadioButton id="RD_DraftNo" runat="server" Text="Column Name" __designer:wfdid="w351" GroupName="A"></asp:RadioButton> </TD></TR><TR></TR></TBODY></TABLE><uc1:AlphaSelection id="AlphaSelection1" runat="server" __designer:wfdid="w352"></uc1:AlphaSelection> 
</ContentTemplate>
</ajaxToolkit:TabPanel>
...
<HeaderStyle HorizontalAlign="Left"></HeaderStyle>
    ...
    <asp:ObjectDataSource ID="SP_RPS_Draft_ALL" runat="server" OldValuesParameterFormatString="original_{0}"
        SelectMethod="Get_RPS_LOV_DataConfigurationDetail_ALL" TypeName="LOV_COLLECTION">
        <SelectParameters>
            <asp:SessionParameter DefaultValue="%" Name="P_CONF_ID" SessionField="Configuration_ID"
                Type="String" />
            <asp:Parameter Name="P_column_order" Type="String" />
            <asp:Parameter Name="P_column_name" Type="String" />
        </SelectParameters>
