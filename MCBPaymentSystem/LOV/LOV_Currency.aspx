<%@ Page Language="C#" MasterPageFile="~/MasterPage/RoutinePage.master" AutoEventWireup="true" CodeFile="LOV_Currency.aspx.cs" Inherits="CurrencySetup_frmCMN_Currency" Title = "Currency Setup - LOV" %>
<%@ Register
...
Text="Currency Setup" Width="100%" SkinID="Heading"></asp:Label>
...
<TABLE style="FONT-SIZE: 8pt; FONT-FAMILY: Verdana" width="100%"><TBODY><TR align=right><TD style="WIDTH: 25%; TEXT-ALIGN: right">Currency Code :&nbsp; </TD><TD style="WIDTH: 25%; TEXT-ALIGN: left">
    &nbsp;<asp:TextBox id="TXT_CurrencyCode" runat="server" SkinID="TXT" Width="200px"></asp:TextBox> </TD><TD style="WIDTH: 25%; TEXT-ALIGN: right">Currency Name :&nbsp; </TD><TD style="WIDTH: 25%; TEXT-ALIGN: left">
    &nbsp;<asp:TextBox id="TXT_CurrencyName" runat="server" SkinID="TXT" Width="200px"></asp:TextBox> </TD></TR></TBODY></TABLE>
</ContentTemplate>
<HeaderTemplate>
Basic Search
</HeaderTemplate>
...
<table style="font-size: 8pt; font-family: Verdana" width="100%">
                        <tr>
                            <td style="width: 25%; text-align: center">
                                <asp:RadioButton ID="RD_CurrencyCode" runat="server" GroupName="A" Text="Currency Code"  /></td>
                            <td style="width: 25%; text-align: center">
                                <asp:RadioButton ID="RD_CurrencyName" runat="server" GroupName="A" Text="Currency Name"  /></td>
                        </tr>
                        <tr>
                        </tr>
                   </table>
...
Alpha Search
        ...
        </eo:ToolBar><TABLE class="login" cellSpacing=0 width="100%"><TBODY><TR><TD><asp:Label style="FONT-WEIGHT: bold; FONT-SIZE: 9pt; FONT-FAMILY: Arial, Tahoma" id="LBL_GridStatus" runat="server" Width="100px"></asp:Label></TD><TD style="WIDTH: 203px"><asp:Label style="FONT-WEIGHT: bold; FONT-SIZE: 10pt; FONT-FAMILY: Arial, Tahoma" id="LBL_RowStatus" runat="server" Width="200px"></asp:Label></TD><TD width="100%"></TD><TD><asp:ImageButton id="CMD_MoveFirst" onclick="CMD_MoveFirst_Click" runat="server" ImageUrl="~/Images/MoveTop.gif"></asp:ImageButton></TD><TD><asp:ImageButton id="CMD_MoveBack" onclick="CMD_MoveBack_Click" runat="server" ImageUrl="~/Images/MovePrevious.gif"></asp:ImageButton></TD><TD><asp:DropDownList id="DRP_LIST" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DRP_LIST_SelectedIndexChanged">
</asp:DropDownList></TD><TD><asp:ImageButton id="CMD_MoveNext" onclick="CMD_MoveNext_Click" runat="server" ImageUrl="~/Images/MoveNext.gif"></asp:ImageButton></TD><TD><asp:ImageButton id="CMD_MoveLast" onclick="CMD_MoveLast_Click" runat="server" ImageUrl="~/Images/MoveLast.gif"></asp:ImageButton></TD></TR></TBODY></TABLE><TABLE style="BACKGROUND-COLOR: gainsboro" class="login" cellSpacing=0 width="100%"><TBODY><TR><TD style="FONT-SIZE: 9pt; COLOR: #444444; FONT-FAMILY: Arial, Tahoma; TEXT-ALIGN: left" colSpan=4><asp:GridView style="WIDTH: 100%" id="GridView1" runat="server" Width="100%" Font-Size="8pt" Font-Names="Verdana" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="ID" OnRowDataBound="GridView1_RowDataBound" PageSize="20" ShowFooter="True" DataSourceID="SP_CMN_Currency_ALL">
...
<asp:BoundField DataField="CurrencyCode" SortExpression="CurrencyCode" HeaderText="Currency Code">
<HeaderStyle HorizontalAlign="Left"></HeaderStyle>
</asp:BoundField>
<asp:BoundField DataField="CurrencyName" SortExpression="CurrencyName" HeaderText="Currency Name">
<HeaderStyle HorizontalAlign="Left"></HeaderStyle>
</asp:BoundField>
...
<PagerStyle BorderStyle="Solid" BorderColor="#404040"></PagerStyle>
    ...
    <asp:ObjectDataSource ID="SP_CMN_Currency_ALL" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Get_CMN_Currency_ALL" TypeName="LOV_COLLECTION">
        <SelectParameters>
            <asp:SessionParameter DefaultValue="%" Name="CurrencyCode" SessionField="CMN_Currency_CurrencyCode"
                Type="String" />
            <asp:SessionParameter DefaultValue="%" Name="CurrencyName" SessionField="CMN_Currency_CurrencyName"
                Type="String" />
        </SelectParameters>
