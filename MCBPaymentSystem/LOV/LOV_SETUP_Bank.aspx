<%@ Page Language="C#" MasterPageFile="~/MasterPage/RoutinePage.master" AutoEventWireup="true" CodeFile="LOV_SETUP_Bank.aspx.cs" Inherits="CustomerSetup_LOV_Customer" Title = "Customer Setup-LOV" %>
...
--%><asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <asp:Label ID="Label1" runat="server" Font-Names="Trebuchet MS" Font-Size="20pt"
        SkinID="Heading" Text="Bank Setup" Width="100%"></asp:Label>
...
<ContentTemplate>
<TABLE style="FONT-SIZE: 8pt; FONT-FAMILY: Verdana" width="100%"><TBODY><TR align=right><TD style="WIDTH: 25%; TEXT-ALIGN: right" class="ColLines1">Bank&nbsp;Code :</TD><TD style="WIDTH: 25%; TEXT-ALIGN: left">&nbsp;<asp:TextBox id="TXT_BankCode" runat="server" Width="200px" SkinID="TXT" MaxLength="5" __designer:wfdid="w189"></asp:TextBox> </TD><TD style="WIDTH: 25%; TEXT-ALIGN: right" class="ColLines1">Bank&nbsp;Name :</TD><TD style="WIDTH: 25%; TEXT-ALIGN: left">&nbsp;<asp:TextBox id="TXT_BankName" runat="server" Width="200px" SkinID="TXT" MaxLength="50" __designer:wfdid="w190"></asp:TextBox> </TD></TR></TBODY></TABLE>
</ContentTemplate>
...
<ContentTemplate>
<TABLE style="FONT-SIZE: 8pt; FONT-FAMILY: Verdana" width="100%"><TBODY><TR><TD style="WIDTH: 25%; TEXT-ALIGN: center"><asp:RadioButton id="RD_BankName" runat="server" Text="Bank Name" GroupName="A" __designer:wfdid="w185"></asp:RadioButton> </TD></TR><TR></TR></TBODY></TABLE><uc1:AlphaSelection id="AlphaSelection1" runat="server" __designer:wfdid="w186"></uc1:AlphaSelection> 
</ContentTemplate>
</ajaxToolkit:TabPanel>
...
<Columns>
<asp:BoundField DataField="BankCode" HeaderText="Bank Code" SortExpression="BankCode"></asp:BoundField>
...
<HeaderStyle HorizontalAlign="Left"></HeaderStyle>
    ...
    <asp:ObjectDataSource ID="PS_SP_CorrBank_LOV" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Get_PS_SP_CorrBank_LOV" TypeName="LOV_COLLECTION">
        <SelectParameters>
            <asp:SessionParameter DefaultValue="%" Name="Bank_Code" SessionField="BankCode" Type="String" />
            <asp:SessionParameter DefaultValue="%" Name="Bank_Name" SessionField="BankName" Type="String" />
        </SelectParameters>
